...
<form action="" method="get" name="theform" id="theform">
  ...
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="83%" class="p982">已收短消息</td>
          ...
          <tr>
            <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="98%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="5%" height="30" bgcolor="e8f2ff"><strong>ID</strong></td>
                  <td width="51%" bgcolor="e8f2ff"><strong>标题</strong></td>
                  <td width="11%" align="center" bgcolor="e8f2ff"><strong>接收人</strong></td>
                  <td width="14%" align="center" bgcolor="e8f2ff"><strong>发送时间</strong></td>
                  <td width="10%" align="center" bgcolor="e8f2ff"><strong>是否阅读</strong></td>
                  <td width="9%" align="center" bgcolor="e8f2ff">&nbsp;</td>
                </tr>
                <tr>
...
%>					
                <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
                  <td height="30"><%=k%></td>
                  <td><a href="<%=Common.getFormatStr(rs.getString("id"))%>" target="_blank"><%=Common.getFormatStr(rs.getString("title"))%></a></td>
                  <td align="center"><%=Common.getFormatStr(rs.getString("sender_mem_name"))%></td>
                  <td align="center"><%=Common.getFormatStr(rs.getString("add_date"))%></td>
                  <td align="center"><%=Common.getFormatStr(rs.getString("is_read"))%></td>
                  <td align="center"><span class="p92"><a href="javascript:deleteData('<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;</span></td>
                </tr>
...
%>
<tr >
                  <td height="30" colspan="6"><a href="#" onclick="pageSumit('0');">首页</a> <a href="#" onclick="pageSumit('<%=pagination.getPrev()%>');">上一页</a> <a href="#" onclick="pageSumit('<%=pagination.getNext()%>');" >下一页</a> <a  href="#" onclick="pageSumit('<%=pagination.getLast()%>');" >末页</a>
