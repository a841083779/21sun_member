...
try{     
	...
	if(flagvalue.equals("1")){
	   ...
	   if(!zd_mem_no.equals("")){   
	    ...
	    if(result>0){
		out.print("<script>alert('资料修改成功!');window.location.href='indiv_info_opt.jsp';</script>");
		}else{
...
<div class="loginlist_right">
  ...
  <div class="loginlist_right1">
	...
	<tr>
	  <td height="22" colspan="2" ><strong>‘我的二手商务室’个性化设置</strong></td>
	  </tr>
	<tr>
          <td width="22%" height="22"   class="right">二手企业推荐关键字：</td>
          <td width="78%" height="22" ><input name="zd_used_popkeywords" type="text" id="zd_used_popkeywords" size="66" value="<%=Common.getFormatStr(memberInfo.get("used_popkeywords"))%>"  class="moren"/></td>
    </tr>
	<tr>
	  <td height="22" colspan="2" >说明：为店铺设置有效关键词，有利于您的商铺和发布的二手设备更容易被搜索引擎收录，可以设置多个关键词，两个关键词之间请用全角“，”隔开。例如：贵公司主要销售二手履带挖掘机、轮式挖掘机，可设置关键词为：二手履带挖掘机、轮式挖掘机。</td>
	  </tr>
	<tr>
	  <td height="22" colspan="2"><strong>‘配件网空间站’个性化设置 </strong></td>
	  </tr>
	<tr>
          <td height="22"   class="right">配件企业推荐关键字：</td>
	...
	<tr>
	  <td height="22" colspan="2">说明：为专卖店设置有效关键词，有利于您的专卖店和发布的供求信息更容易被搜索引擎收录，可以设置多个关键词，两个关键词之间请用全角“，”隔开。例如：贵公司主要销售斗山挖掘机配件，可设置关键词为：斗山挖掘机配件。</td>
	  </tr>
	<tr>
	  <td height="22" colspan="2" ><strong>‘配套网空间站’个性化设置 </strong></td>
	  </tr>
	<tr>
		<td height="22"   class="right">品牌站（形象站）公告：</td>
		<td height="22" ><textarea name="zd_fittings_bulletin" cols="50" rows="3" id="zd_fittings_bulletin" onkeyup="if((this.value).length&gt;300){ this.value=(this.value).substr(0,300);alert('描述请控制在300个汉字以内。');}"><%=Common.filterHtmlString(Common.getFormatStr(memberInfo.get("fittings_bulletin")).replace("<br />","\r\n"))%></textarea></td>
	</tr>
	<tr>
	  <td height="22" colspan="2">此信息将在您的品牌站或形象站的企业公告处显示，可对企业最新产品、服务和优惠政策进行公告！</td>
	  </tr>
	<tr>
		<td height="22"   class="right">企业配套服务：</td>
		<td height="22" ><textarea name="zd_fittings_service" cols="50" rows="3" id="zd_fittings_service" onkeyup="if((this.value).length&gt;300){ this.value=(this.value).substr(0,300);alert('描述请控制在300个汉字以内。');}"><%=Common.filterHtmlString(Common.getFormatStr(memberInfo.get("fittings_service")).replace("<br />","\r\n"))%></textarea></td>
	</tr>
	<tr>
	  <td height="22" colspan="2" >贵企业目前不为整机企业提供配套服务，可以不填写此项内容！</td>
	  </tr>
	<tr>
		<td height="22"   class="right">企业招商政策：</td>
		<td height="22" ><textarea name="zd_fittings_businepolic" cols="50" rows="3" id="zd_fittings_businepolic" onkeyup="if((this.value).length&gt;300){ this.value=(this.value).substr(0,300);alert('描述请控制在300个汉字以内。');}"><%=Common.filterHtmlString(Common.getFormatStr(memberInfo.get("fittings_businepolic")).replace("<br />","\r\n"))%></textarea></td>
	</tr>
	<tr>
	  <td height="22" colspan="2">此信息将在您发布的‘产品信息’中显示，以便更好的向配件代理商宣传企业的招商政策，促进合作。</td>
	  </tr>
