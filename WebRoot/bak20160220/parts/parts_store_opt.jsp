...
//=====页面属性====
String pagename="parts_store_opt.jsp";
String mypy="supply_partstore";
String titlename="";
...
String urlpath="../parts/parts_store_opt.jsp";
if(!myvalue.equals("")){
...
String session_per_phone = Common.getFormatStr((String)userInfo.get("comp_name"));
if(session_per_phone.equals("-9999")) session_per_phone="";

String pubCount   = "0";
String today= Common.getToday("yyyy-MM-dd HH:mm:ss",0);
...
<div class="loginlist_right">
  <div class="loginlist_right2"><span class="mainyh"><%if(!myvalue.equals("")){%>更新<%}else{ %>发布<%} %>配件仓库</span></div>
...
　　　　<!--　<%if(session_mem_flag.equals("-1")){%> 每天发布信息量最多只可以发布<font color="red"><b>5</b></font>条，您今天已经发布了<font color="green"><b><%=pubCount%></b></font>条。<%}%>--></td>
      </tr>
    </table>
    ...
    <table width="95%" border="0" align="center" class="tablezhuce">
        <tr>
          <td  class="right" nowrap="nowrap"><span class="grayb"><span class="red">*</span> 品　　牌：</span></td>
          <td height="22" class="list_cell_bg">
          	<select name="zd_brand" id="zd_brand" onchange="brandChange(this)" class="blue1" style="width:133px">
				...
				<option value="DAJIANG">大江</option>
				...
				<option value="shangchai">上柴</option>
				...
				<option value="ZGZQHF">中国重汽杭发</option>
				...
				<option value="韩国进口FNM">韩国进口FNM</option>
        ...
        <tr>
          ...
          <td height="22" class="list_cell_bg"><input type="text" id="zd_price" name="zd_price" value="" size="20" maxlength="60" onblur="checkNum(this,1)" class="moren" style="vertical-align:middle;line-height:11px;padding:1px 1px; 0;font:12px arial"/></td>
        </tr>
		<tr>
          <td  class="right" nowrap="nowrap"><span class="grayb">数　　量：</span></td>
          <td height="22" class="list_cell_bg"><input type="text" id="zd_amount" name="zd_amount" value="" size="20" maxlength="60" onblur="checkNum(this,1)" class="moren" style="vertical-align:middle;line-height:11px;padding:1px 1px; 0;font:12px arial"/></td>
        </tr>  
		   <tr>
          <td class="right" nowrap="nowrap"><span class="grayb">产　　地：</span></td>
          <td height="22" class="list_cell_bg"><input name="zd_place" type="radio" id="zd_place1" value="0" checked="checked">
          国内<input type="radio" id="zd_place1" name="zd_place" value="1">国外</td>
        </tr>
		  <tr>
        ...
        <tr>
          ...
          <td height="22" class="list_cell_bg"><input type="radio" id="zd_is_pub" name="zd_is_pub" value="1" checked="checked" style="border:0";/>
            是
            <input type="radio" id="zd_is_pub" name="zd_is_pub" value="2" style="border:0";/>
            否 </td>
        </tr>
        <tr>
