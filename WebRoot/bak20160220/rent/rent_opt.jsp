...
<body>
  ...
  <div class="loginlist_right2"><span class="mainyh" style="float:left;"s>发布租赁信息</span><%if(mem_flag.equals("1005")){ %><div style="width:120px; float:right;line-height:35px; font-weight:bold;"><a href="http://www.21-rent.com/shop/shopdetail<%=rent_mode %>_for_<%=comp_id %>.htm" target="_blank">进入我的店铺&gt;&gt;</a><%} %></div>
  ...
  <table width="95%" border="0" align="center" class="tablezhuce">
    ...
    <tr>
       ...
       <td class="list_cell_bg"><input name="zd_title" type="text" id="zd_title" size="60" maxlength="25" class="required"  onKeyDown="javascript:checkradio();">（标题请填写25字之内）</td>
    </tr>
    <tr>
       <td align="right" nowrap class="list_left_title"><strong>Q　　Q：</strong></td>	
       <td class="list_cell_bg"><input name="zd_per_qq" type="text" id="zd_per_qq" size="60" maxlength="40" class="required" value="<%=per_qq %>"  onKeyDown="javascript:checkradio();"></td>
    </tr>
	<tr>
