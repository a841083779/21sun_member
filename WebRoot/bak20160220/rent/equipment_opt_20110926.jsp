...
function showImg(obj){
   ...
   if(obj=="1"){ 
		for(var i=2;i<=5;i++){			     
			document.getElementById('showimg'+i).style.display ='';			
		}	
      ...
      <table>
        ...
        <select  name="zd_city" id="zd_city"  style="width:100px;">
          <option value="">选择城市</option>
              ...
              <tr>
                <td colspan="4" class="biaoge_title"><strong>设备详细信息</strong></td>
              </tr>
              <tr>
                ...
                <td height="22" class="list_cell_bg"><input type="radio" id="zd_is_operater" name="zd_is_operater"
												value="1" >
                  是
              ...
              <tr>
                ...
                <td height="22" class="list_cell_bg" width="500"><input type="radio" id="radio" name="zd_rent_state"
												value="1" checked="checked">
                  待租
                    <input type="radio" id="radio" name="zd_rent_state"
												value="2">
                  施工中 </td>
              </tr>
              <tr>
              ...
              <tr id="showimg1" style="display:''">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img1" id="zd_img1" type="hidden" value="" />
                  ...
                  </span><a href="javascript:showImg('1');"><font id="openImg" color='green' ><img src="images/open.gif" /></font></a> <a href="javascript:showImg('2');"><font id="closeImg" style="display:none" color='red'><img src="images/close.gif" /></font></a>&nbsp;&nbsp;注：图片最大不超过200K,大小625*456</td>
              </tr>
              <tr id="showimg2" style="display:none">
              ...
              <tr id="showimg3" style="display:none">
              ...
              <tr id="showimg4" style="display:none">
              ...
              <tr id="showimg5" style="display:none">
