...
<form action="opt_save_update.jsp" method="post" name="theform" id="theform">
  <div class="loginlist_right">
    <div class="loginlist_right2"> <span class="mainyh" style="float:left">发布租赁设备信息</span> <%if(mem_flag.equals("1005")){ %><div style="width:120px; float:right;line-height:35px; font-weight:bold;"><a href="http://www.21-rent.com/shop/shopdetail<%=rent_mode %>_for_<%=comp_id %>.htm" target="_blank">进入我的店铺&gt;&gt;</a><%} %></div></div>
              ...
              <tr id="showimg1" style="display:''">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img1" id="zd_img1" type="hidden" value="" />
                  ...
                  <iframe id="ifr2_zd_img1" scrolling="no" frameborder="0" width="100%" height="28"
						...
						+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img1&smallpic=zd_img1_1"></iframe>
              ...
              <tr id="showimg2">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img2" id="zd_img2" type="hidden" value="" />
                  ...
                  <iframe
													...
													width="100%" height="28"
													src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName() + ":"
						+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img2"></iframe>
                  </span> </td>
              </tr>
              <tr id="showimg3">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img3" id="zd_img3" type="hidden" value="" />
                  ...
                  <iframe
													...
													width="100%" height="28"
													src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName() + ":"
						+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img3"></iframe>
                  </span> </td>
              </tr>
              <tr id="showimg4">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img4" id="zd_img4" type="hidden" value="" />
                  ...
                  <iframe
													...
													width="100%" height="28"
													src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName() + ":"
						+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img4"></iframe>
                  </span> </td>
              </tr>
              <tr id="showimg5">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img5" id="zd_img5" type="hidden" value="" />
                  ...
                  <iframe
													...
													width="100%" height="28"
													src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName() + ":"
						+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img5"></iframe>
                  </span> </td>
              </tr>
