...
<div class="loginlist_right">
  <div class="loginlist_right2"><span class="mainyh">管理设备收藏</span></div>
  <div class="loginlist_right1"><a href="collect_store_list.jsp"><img src="./images/dp.gif" style="border:0px;height:27px"/> </a><table width="100%" border="0" class="list">
      <tr>
        <th width="4%">序</th>
        <th width="33%">标题</th>
		<th width="9%">类别</th>
...
%>		  
      <tr>
		...
		<td><%=flag.equals("1")?"设备":(flag.equals("2")?"店铺":"")%></td>
