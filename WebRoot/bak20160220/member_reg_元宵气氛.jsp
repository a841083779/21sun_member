...
<div class="New_registTop contain950" style="background:url(/images/logo_yx201403.jpg) no-repeat;">
  <h1><a href="http://www.21-sun.com/" target="_blank" style="display:block; width:190px; height:90px;"><img src="images/new_logo.gif" alt="中国工程机械商贸网" style="visibility:hidden;" /></a></h1>
  <h2>用户注册</h2>
</div>
<div class="registForm">
  <div class="registBg">
    <div class="registTop">
      <h3>注册新用户</h3>
      <span>我已经注册，现在就 <a href="<%if(!source.equals("")){ %>member_login.jsp?source=<%=source%><%}else{ %>member_login.jsp<%} %>" class="blue">登录</a></span>
    </div>
    <div class="registTable">
      <form id="theform" name="theform" method="post" action="member_reg_action_rand02.jsp"  onsubmit="return regYanzheng();" >
    ...
    <div style="position: absolute; top: 61px; left: 21px;"><a title="爱在铁臂，难以离开！" target="_blank" href="http://www.wajueji.com/activity/fallINlove.jsp"><img width="182" height="477" alt="爱在铁臂，难以离开！" src="/images/ad_zhuce_01.jpg"></a></div>
  </div>
  <div class="clear"></div>
</div>
...
<!--对联广告-->
<div id="ads01">
<a href="http://www.wajueji.com/activity/fallINlove.jsp" target="blank" title="爱铁臂，赢模型，十万奖品任你拿" onmouseover="document.getElementById('ads01').className='ads_hover';document.getElementById('ads02').className='ads_hover'" onmouseout="document.getElementById('ads01').className='';document.getElementById('ads02').className=''" style="display:block;"><img src="http://ad.21-sun.com/homepic/xdl/right_x.gif" width="42" height="330" alt="爱铁臂，赢模型，十万奖品任你拿" class="ads_small" /><img src="http://ad.21-sun.com/homepic/xdl/right_d.jpg" width="95" height="330" alt="爱铁臂，赢模型，十万奖品任你拿" class="ads_big" /></a>
...
<script type="text/javascript">
	...
	function Timer(){
		Time--;
		jQuery('div.code-sent').find('strong').text(Time);
		if( Time == 0 ){
		Time = 90;
		jQuery('div.code-sent').hide().end().find('strong').text(Time);
	 	 ...
	 	 success:function(msg){ 
	 	    if(jQuery.trim(msg)==1){
	 	    	 jQuery("#getRandTxt").show() ;
	  			 ...
	  			 var phone = $.trim($("#per_phone").val());
	  			 //判断是否中国移动的号码
	  			 if(phone.indexOf("134")==0 || phone.indexOf("135")==0 || phone.indexOf("136")==0 || phone.indexOf("137")==0 || phone.indexOf("138")==0 || phone.indexOf("139")==0 || phone.indexOf("150")==0 || phone.indexOf("151")==0 || phone.indexOf("152")==0 || phone.indexOf("157")==0 || phone.indexOf("158")==0 || phone.indexOf("159")==0 || phone.indexOf("182")==0 || phone.indexOf("187")==0 || phone.indexOf("188")==0 || phone.indexOf("147")==0){
	  			 	jQuery("#getRandTxt div").html("验证码将发送到您的手机上<br/>近期由于国家政策与运营商的限制，导致部分移动号码收不到短信，若 <strong>90</strong> 秒后仍未收到验证码短信，请致电0535-6792736与客服联系！");
	  			 }else{
