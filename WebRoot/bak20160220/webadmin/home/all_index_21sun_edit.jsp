  ...
  <table border="0" cellspacing="1" width="100%" bordercolordark="#FFFFFF" class="pCC0E24" bordercolorlight="#008080" >
    ...
    <tr>
      ...
      <td width="85%"  ><input name="zd_img"  type="text" Class="xmlInput textInput5" id="zd_img" value="" size="50" >
        <input type="button" name="buttton" value="上传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=member.21-sun.com:80&websiteId=29&dir=aboutus&fieldname=zd_img','upload',480,150)">      </td>
    </tr>
    <tr>
    ...
    <td  ><input name="zd_order_no"  type="text"  Class="xmlInput textInput5" id="zd_order_no" value="" size="5">    </tr>
	 <tr>
