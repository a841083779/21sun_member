...
if(pool==null){
	pool = new PoolManager();
	 ...
	 String pageSubName = "index_21sun_edit_special.jsp";
	...
	try {
		...
		String query = "select * from index_21sun "+searchStr+" and sort_flag in(20,21) order by sort_flag,order_no";		System.out.print("...." + query);
  ...
  <table width="95%"  border="0"  cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <option value="20" <%if(sort_flag.equals("20"))out.print("selected");%>>首页原创</option>
          <option value="21" <%if(sort_flag.equals("21"))out.print("selected");%>>专题推荐</option>
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
			<td height="15" width="10%" align="center">
           	<a href="http://www.21-sun.com/tools/createYuanChuang.jsp" target="_blank">首页原创</a>
            </td>
			<td height="15" width="10%" align="center">
           	<a href="http://www.21-sun.com/tools/createSpecial.jsp" target="_blank">专题推荐</a>
           	</td>
           	<td>&nbsp;</td>			
          </tr>
        </table>
          ...
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%> >
           ...
           <td    >
                                             ...
                                             <a href="#" onclick="openWin('<%=pageSubName%>?id=<%=rs.getString("id")%>&flag=1','win',800,600)">
											   ...
											   if("20".equals(type_flag)){
											   		type = "首页原创";
											   }else if("21".equals(type_flag)){
											   		type = "专题推荐";
											   }											   
											   %>
											   <%=type%>
