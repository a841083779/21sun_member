...
if(pool==null){
	pool = new PoolManager();
	 ...
	 String pageSubName = "all_index_21sun_edit.jsp";
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
           ...
           <a href="http://www.21-sun.com/tools/createDataAnalysis.jsp" target="_blank">数据分析</a>
            ...
            <td height="15" width="8%">
           <a href="http://www.21-sun.com/tools/createNewVideo.jsp" target="_blank">最新视频</a>
            </td>
            <td height="15" width="8%">
           <a href="http://www.21-sun.com/tools/createNetHot.jsp" target="_blank">本网热点</a>
            </td>
            <td height="15" width="8%">
           <a href="http://www.21-sun.com/tools/createHyMessage_peitao.jsp" target="_blank">新版资讯</a>
            </td>
            <td height="15" width="8%">
           <a href="http://www.21-sun.com/tools/createVideoPlay.jsp" target="_blank">视频直播</a>
            </td>
            <td height="15" width="6%">
           <a href="http://www.21-sun.com/tools/createNewOrder.jsp" target="_blank">排行榜</a>
            </td>
			<td height="15" width="9%">
