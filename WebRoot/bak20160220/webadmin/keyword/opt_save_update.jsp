...
if(result>0){
	//修改关键词时，同步修改相关信息关联的关键词
	if(!myvalue.equals("") && Common.decryptionByDES(mypy).equals("keyword_search")){
		String updateKeyword = " update keyword_search_title set keyword = '"+Common.getFormatStr(request.getParameter("zd_title"))+"' where keyword_id = '"+myvalue+"' ";
		DataManager.dataOperation(pool,updateKeyword);
	}
%>
	<script>
		alert("OK！操作成功！");
