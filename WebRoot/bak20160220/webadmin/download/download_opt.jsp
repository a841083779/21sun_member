...
//=====页面属性====
String pagename="download_opt.jsp";
String mypy="article_other";
String titlename="资料下载";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));


String urlpath="../download/download_opt.jsp";
if(!myvalue.equals("0"))
...
function submityn(){
	if($("#zd_title").val()==""){
			...
			$("#zd_title").focus();
			return false;
	}else if($("#zd_sub_sort_num").val()==""){
			alert("请选择类型！");
			$("#zd_sub_sort_num").focus();
			return false;
		}			
		theform.submit();
}
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      ...
      <td class="list_cell_bg"><select name="zd_sub_sort_num" id="zd_sub_sort_num">
                <option value="">--请选择类型--</option>
				<option value="100">挖掘机</option>
                <option value="1001">&nbsp;&nbsp;小松系列</option>
				<option value="1002">&nbsp;&nbsp;卡特系列 </option>
				<option value="1003">&nbsp;&nbsp;加藤挖机 </option>
				<option value="1004">&nbsp;&nbsp;沃尔沃系列</option>
				<option value="1005">&nbsp;&nbsp;神钢系列</option>
				<option value="1006">&nbsp;&nbsp;住友挖机</option>
				<option value="1007">&nbsp;&nbsp;日立系列</option>
                <option value="1008">&nbsp;&nbsp;现代系列</option>
                <option value="1009">&nbsp;&nbsp;大宇系列</option>
                <option value="100A">&nbsp;&nbsp;其他挖机</option>
				<option value="200">装载机专区</option>
                <option value="300">摊铺机专区</option>
				 <option value="400">推土机专区</option>
                <option value="500">压路机专区</option>
                <option value="600">其它机械区</option>
              </select>
        <input type="hidden" name="zd_sort_num" id="zd_sort_num" value="0700"></td>
    </tr>
    <tr>
    ...
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
		  ...
		  <input name="zd_catalog_no" type="hidden" id="zd_catalog_no" value="700401">
