...
String tablename="bidding_organization";
  ...
  <tr>
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="65%" align="center" nowrap="nowrap">机构名称：
          <input name="find_name" type="text" id="find_name" size="15" value="<%=find_name%>" />
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15">
              <input type="button" name="b_add" value="增加" onclick="openWin('bidding_organization_opt.jsp','sell',750,650)"/>
              <a href="http://www.21-sun.com/bidding/tools/createIndex.jsp" target="_blank">更新首页静态页数据</a>
              </td>
          </tr>
        </table>
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="56%" bgcolor="e8f2ff"><strong>机构名称</strong></td>
            <td width="14%" align="center" bgcolor="e8f2ff"><div align="center"><strong>加入日期</strong></div></td>
...
%><tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><%=Common.getFormatStr(rs.getString("in_date"))%></div></td>
            <td align="center"><div align="center"><span class="p92j"><%=Common.getFormatStr(rs.getString("is_show")).equals("1")?"显示":"不显示"%></span></div></td>
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:deleteData('<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('bidding_organization_opt.jsp?myvalue=<%=rs.getString("id")%>','sell',650,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
