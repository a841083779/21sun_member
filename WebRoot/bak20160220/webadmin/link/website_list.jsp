          ...
          <table width="97%"  border="0" cellpadding="0" cellspacing="0" id="table5">
            <tr>
              <td width="12%" class="title_bar"><span class="title_bar">
                <input name="add_b" type="button" class="form_button" id="add_b" value="增加" onClick="openWin('website_add.jsp','add',500,400)">
                </span></td>
              <td width="70%" align="center" class="title1"> 站点名称 ：
  ...
  <div align="center">
    <table width="97%" border="0" cellpadding="4" cellspacing="1" class="table_border_bg" style="background-color: #717EA2" id="table2">
      <tr bgcolor="#e8f2ff">
        ...
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">站点名称</strong></td>
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">刷新地址</strong></td>
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">连接池标识</strong></td>
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">是否显示</strong></td>
...
%>
      <tr  <%=j%2==0?"bgcolor='#E8EAF0'":"bgcolor='#FFFFFF'"%>>
        ...
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("website_addr")) + Common.getFormatStr(rs.getString("refresh_addr"))%></td>
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("pool_tag"))%></td>
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("is_show")).equals("1")?"是":"否"%></td>
        <td align="center" nowrap ><a href="#" onClick="openWin('website_add.jsp?id=<%=Common.getFormatStr(rs.getString("id"))%>','modi',500,400)">修改</a>&nbsp;&nbsp; <a href="#" onClick="javascript:deleteData('<%=rs.getString("id")%>','<%=tablename %>');">删除</a></td>
      </tr>
      <%}%>
