					...
					<form method="POST" action="opt_save.jsp" name="theform"  >
						...
						<div align="center" class="loginlist_right1">
							...
							<table border="0" cellpadding="2" cellspacing="0" width="100%"  >
								<tr>
									<td width="10%" align="right" nowrap><font color="#FF0000">*</font> <span class="grayb">用户名：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_mid" value="<%=usern %>" size="50" maxlength="20" >
									 </td>         
								</tr>
