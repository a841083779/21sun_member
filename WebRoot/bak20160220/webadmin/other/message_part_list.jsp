...
String pageSubName="message_part_opt.jsp";
//======================
...
<script type="text/javascript">
	function export_message(){
		var sort_flag=$("#find_sort_flag").val();
		var title=$.trim($("#findTitle").val());
		window.location.href="/webadmin/parts/message_list_export.jsp?sort_flag="+sort_flag+"&title="+title;
	}
</script>
</head>
<body>
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="65%" align="center" nowrap="nowrap"><span class="title1">
              <select name="find_sort_flag" id="find_sort_flag">
                ...
                <option value="1" <%if(find_sort_flag.equals("1"))out.print("selected");%>>供货</option>
              ...
              <input type="button" name="export_list" value="导出配件留言信息" onclick="export_message();" />
              </span>
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="61%" bgcolor="e8f2ff"><strong>内容</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td><a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)"><%=Common.getFormatStr(rs.getString("content"))%></a></td>
...
function doDelAll(){
	...
	window.location.href="/webadmin/other/message_part_list.jsp?site_flag=4&ids="+idStr;
}
