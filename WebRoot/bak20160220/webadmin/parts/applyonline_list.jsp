...
if(!mem_name.equals("")){
	query.append(" and mem_name like '%"+mem_name+"%'");
}
  ...
  <tr>
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="4%" height="30" align="center" bgcolor="e8f2ff"><strong>序</strong></td>
            <td width="9%" bgcolor="e8f2ff"><strong>申请人姓名</strong></td>
            <td width="29%" align="center" bgcolor="e8f2ff"><div align="center"><strong>公司名称</strong></div></td>
            <td width="30%" align="center" bgcolor="e8f2ff"><strong>联系方式/Email</strong></td>
			<td width="11%" align="center" bgcolor="e8f2ff"><strong>申请会员类别</strong></td>
            <td width="11%" align="center" bgcolor="e8f2ff"><strong>日期</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('../parts/opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp;</span></div></td>
          </tr>
          <%
}
%>
