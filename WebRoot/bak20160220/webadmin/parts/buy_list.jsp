    ...
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15">
              ...
              <input type="button" name="b_add" value="增加" onclick="openWin('buy_opt.jsp','sell',650,600)"/>
            </a></td>
          </tr>
        </table>
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="15%" bgcolor="e8f2ff"><strong>发布日期</strong></td>
            <td width="8%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>求购者</strong></span></div></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td title="<%=Common.getFormatStr(rs.getString("id"))%>"><a href="#" onclick="openWin('buy_opt.jsp?myvalue=<%=rs.getString("id")%>','',650,600)"><%=Common.getFormatStr(rs.getString("title"))%></a><font color='#FF0000'><%if(!mem_flag.equals("-1")){out.print(Common.getFormatStr(memFlaghp.get(mem_flag)));}%></font></td>
            <td><%=Common.getFormatDate("yyyy-MM-dd",rs.getDate("pubdate"))%></td>
            <td align="center"><div align="center"><a href="#" onclick="openWin('../member/member_opt.jsp?mem_no=<%=Common.getFormatStr(rs.getString("mem_no"))%>','',750,600)"><%=Common.getFormatStr(rs.getString("mem_no"))%>/<%=Common.getFormatStr(rs.getString("mem_name"))%></a></div></td>
            <td align="center"><div align="center"><span class="p92j"><%=Common.getFormatStr(rs.getString("is_pub")).equals("1")?"显示":"不显示"%></span></div></td>
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('../parts/opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('buy_opt.jsp?myvalue=<%=rs.getString("id")%>','',650,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
