...
String tablename="ad_region_info";
  ...
  <tr>
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="65%" align="center" nowrap="nowrap">展场名称：
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15">
              <input type="button" name="b_add" value="增加" onclick="openWin('region_opt.jsp','region',650,600)"/>
            </a></td>
          </tr>
        </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="22%" bgcolor="e8f2ff"><strong>区域名称</strong></td>
            <td width="25%" align="center" bgcolor="e8f2ff"><div align="center"><strong>展场名称</strong></div></td>
            <td width="12%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>是否显示</strong></span></div></td>
            <td width="38%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>操作</strong></span></div></td>
          </tr>
          <tr>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td><%=Common.getFormatStr(rs.getString("region"))%></td>
            <td align="center"><div align="center"><%=Common.getFormatStr(rs.getString("title"))%></div></td>
            <td align="center"><div align="center"><span class="p92j"><%=Common.getFormatStr(rs.getString("is_pub")).equals("1")?"显示":"不显示"%></span></div></td>
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('../parts/opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('region_opt.jsp?myvalue=<%=rs.getString("id")%>','region',650,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
