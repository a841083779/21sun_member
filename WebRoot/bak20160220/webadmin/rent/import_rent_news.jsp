...
ResultSet rs=DataManager.executeQueryDB2(conn2, "select AREA,CATIDS,TITLE,KEYWORDS,cast(DETAIL as varchar(4000)),FROM,URL,PUBDATE,PUBTIME,CLICKED,ISPUBLISHED,PUBDAYS,ORDER,IMG1,IMGTITLE1,IMG2,IMGTITLE2,IMG3,IMGTITLE3,IMG4,IMGTITLE4,id from zl_news where 1=1 and ISPUBLISHED=1 order by id ");
