...
<%
//=====页面属性====
String pagename="rent_lastnews_opt.jsp";
...
String urlpath="../rent/rent_lastnews_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      <td height="22" align="right" nowrap class="list_left_title">所在地：</td>
    ...
    <tr>
      <td height="22" align="right" nowrap class="list_left_title"><font color="#FF0000">*</font>类型：</td>
      <td height="22" class="list_cell_bg"><select name="zd_type" id="zd_type">
    ...
    <tr>
      <td height="22" align="right" nowrap class="list_left_title">求出租人：</td>
      <td height="22" class="list_cell_bg"><input name="zd_buyer" type="text" id="zd_buyer" size="20" maxlength="40">      </td>
    </tr>
    <tr>
    ...
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
          ...
          <input name="zd_category" type="hidden" id="zd_category" value="700704">
