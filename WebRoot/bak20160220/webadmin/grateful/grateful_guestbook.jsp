...
//=====页面属性====
String tablename="grateful_guestbook";
...
StringBuffer query =new StringBuffer("select * from "+tablename+" ORDER BY add_date DESC");
//得到参数
    ...
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
         ...
         <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15"><input type="button" name="b_del" value="删除" onclick="doDelAll();"/></td>
          </tr>
        </table>
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="5%" height="30" align="center" bgcolor="e8f2ff"><input type="checkbox" value="0" name="allChecked" id="allChecked" /></td>
            <td width="10%" bgcolor="e8f2ff" align="center"><strong>名字</strong></td>
            <td width="10%" bgcolor="e8f2ff" align="center"><strong>电话</strong></td>
            <td width="50%" bgcolor="e8f2ff" align="center"><strong>内容</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td><a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)"><%=Common.getFormatStr(rs.getString("guest_name"))%></a></td>
            <td align="center"><div align="center"><%=rs.getString("guest_phone")%></div></td>
            <td align="center"><div align="center"><%=rs.getString("guest_content")%></div></td>
            <td align="center"><div align="center"><%=Common.getFormatDate("yyyy-MM-dd",rs.getDate("add_date"))%></div></td>
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('../grateful/opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
