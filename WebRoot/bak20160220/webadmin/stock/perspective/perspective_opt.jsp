...
//=====页面属性====
String pagename="perspective_opt.jsp";
String mypy="article";
String titlename="行业解读";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));
String urlpath="/webadmin/stock/perspective/perspective_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>来源：</strong></td>
      <td class="list_cell_bg"><input name="zd_source" type="text" id="zd_source" style="width:300px" maxlength="100" class="required" >
        </td>
    </tr>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>标签：</strong></td>
      <td class="list_cell_bg"><input name="zd_keyword" type="text" id="zd_keyword" style="width:300px" maxlength="100" class="required" >
        </td>
    </tr>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>是否发布：</strong></td>
      <td class="list_cell_bg"><input name="zd_is_pub" type="radio" value="1" checked>是 <input name="zd_is_pub" type="radio" value="0" >否
        </td>
    </tr>
    <tr>
    ...
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
          ...
          <input name="zd_sort_num" type="hidden" id="zd_sort_num" value="40">
          <input name="zd_flag" type="hidden" id="zd_flag" value="1">
