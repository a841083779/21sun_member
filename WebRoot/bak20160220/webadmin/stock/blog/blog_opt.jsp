...
//=====页面属性====
String pagename="blog_opt.jsp";
String mypy="stock_blog";
String titlename="股评";
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      ...
      <td class="list_cell_bg">
      	<select name="zd_author">
      		<option value=""></option>
      		<%=Common.option_str(pool,"stock_expert","name,name","","",0) %>
      	</select>
        <font color="#FF0000">*</font></td>
    </tr>
    <%}else{ %>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>作者：</strong></td>
      <td class="list_cell_bg"><input name="zd_author" type="text" id="zd_author" style="width:120px" maxlength="10" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <%} %>
    <tr>
    ...
    <tr>
      ...
      <td class="list_cell_bg"><input name="zd_tag" type="text" id="zd_tag" style="width:300px" maxlength="100" class="required" >
        </td>
    </tr>
    <tr>
