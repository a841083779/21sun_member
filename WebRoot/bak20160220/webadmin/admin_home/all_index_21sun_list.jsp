...
if(pool==null){
	...
	try {
		...
		String query = "select * from index_21sun "+searchStr+" order by sort_flag,order_no";
  ...
  <table width="95%"  border="0"  cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <option value="1" <%if(sort_flag.equals("1"))out.print("selected");%>>最新咨讯</option>
          <option value="2" <%if(sort_flag.equals("2"))out.print("selected");%>>行业分析报告</option>
          ...
          <option value="5" <%if(sort_flag.equals("5"))out.print("selected");%>>信息</option>
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
           ...
           <a href="http://localhost:9118/tools/createLastNews.jsp" target="_blank">最新咨讯</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createHyReport.jsp" target="_blank">行业分析报告</a>            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createNewProducts.jsp" target="_blank">最新产品</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createHot.jsp" target="_blank">热点</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createMessage.jsp" target="_blank">信息</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createSel.jsp" target="_blank">案例营销</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createHyMessage.jsp" target="_blank">行业信息</a>
            </td>
			<td height="15" width="9%">
           <a href="http://localhost:9118/tools/createDataAnalysis.jsp" target="_blank">数据分析</a>
            </td>
			<td height="15" width="9%">
          <a href="http://localhost:9118/tools/createIndex.jsp" target="_blank">首页全部刷新</a>
            </td>
          ...
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%> >
           ...
           <td    >
                                             ...
                                             <a href="#" onclick="openWin('<%=pageSubName%>?id=<%=rs.getString("id")%>','win',800,600)">
											   ...
											   <%
											   String type = "";
											   String type_flag = Common.getFormatStr(rs.getString("sort_flag"));
											   if("1".equals(type_flag)){
											   		type = "最新咨讯";
											   }else if("2".equals(type_flag)){
											   		type = "行业分析报告";
											   }else if("3".equals(type_flag)){
											   		type = "最新产品";
								             ...
								             <a href="#" onclick="openWin('<%=pageSubName%>?id=<%=rs.getString("id")%>','win',800,600)">修改</a></span></div>								             </td>
          </tr>
          <%
}
%>
