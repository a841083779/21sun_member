...
//=====页面属性====
String tablename="used_news";
String pageSubName="cs_opt.jsp";
//======================
...
StringBuffer query =new StringBuffer("select * from "+tablename+" where 1=1 and catalog_no = 1 ");
//得到参数 测试
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="10%" bgcolor="e8f2ff"><strong>会员编号</strong></td>
