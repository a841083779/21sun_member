...
//=====页面属性====
String tablename="used_brand";
String pageSubName = "brand_opt.jsp";
//======================
...
<form action="" method="get" name="theform" id="theform">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 20px; margin-right: 20px;">
          <tr>
            ...
            <td width="40%" bgcolor="e8f2ff" align="center"><strong>品牌编号</strong></td>
...
%>
          <tr <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
          	<td height="30" align="left"><%=rs.getString("brand_name") %></td>
          	<td align="right"><%=rs.getString("brand")==null?"":rs.getString("brand") %></td>
          	<td align="center">
