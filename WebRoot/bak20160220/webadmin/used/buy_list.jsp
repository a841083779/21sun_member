...
//=====页面属性====
String tablename="buy_new";
String pageSubName="buy_opt.jsp";
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15">
				...
				<input type="button" id="hot" name="hot" value="批量导入供应" onclick="setFlag(2);"/>
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="59%" bgcolor="e8f2ff"><strong>标题</strong></td>
            <td width="11%" bgcolor="e8f2ff"><strong>发布人</strong></td>
