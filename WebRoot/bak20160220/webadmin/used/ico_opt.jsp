...
//=====页面属性====
String pagename="ico_opt.jsp";
String mypy="map_ico";
String titlename="品牌管理";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));

String urlpath="../used/ico_opt.jsp";
...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    <tr>
      ...
      <td>
     	 <input name="zd_ico" type="text" id="zd_ico" size="50" />
      </td>
    </tr>
    <tr >
      <td height="30px" class="list_left_title" align="center" colspan="2">
          ...
          <input name="zd_id" type="hidden" id="zd_id" value="0">
           ...
           <input type="hidden" name="zd_brand_name" id="zd_brand_name" value="柳工" />
           <script type="text/javascript">
           	function setBrandName(){
           		document.getElementById("zd_brand_name").value=document.getElementById("zd_brand_id").options[document.getElementById("zd_brand_id").selectedIndex].innerHTML;
           	}
           	document.getElementById("zd_brand_name").value=document.getElementById("zd_brand_id").options[document.getElementById("zd_brand_id").selectedIndex].innerHTML;
           </script>
		  </div>
