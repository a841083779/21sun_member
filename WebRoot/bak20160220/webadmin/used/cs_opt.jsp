...
<%
//=====页面属性====
String pagename="cs_opt.jsp";
String mypy="used_news";
String titlename="二手新闻";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));

String urlpath="../used/cs_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><strong><span class="STYLE1">会员编号</span>：</strong></td>
      <td class="list_cell_bg"><input name="zd_mem_no" type="text" id="zd_mem_no" size="20" value="<%if(adminInfo != null&&adminInfo.get("usern")!=null)out.print(adminInfo.get("usern"));%>" ></td>
    </tr>
    <tr>
    ...
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
          ...
          <input name="zd_catalog_no" type="hidden" id="zd_catalog_no" value="1">
