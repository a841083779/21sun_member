...
%>
          <tr>
          	<td align="center"><%=rs.getString("mem_name") %></td>
          	<td align="center"><%=rs.getString("province") %></td>
          	<td align="left">
          		<%=rs.getString("title")==null?"":rs.getString("title").length()>10?rs.getString("title").substring(0,10):rs.getString("title") %>
          	</td>
          	<td align="left"><%=rs.getString("mem_contact") %></td>
          	<td align="center">
