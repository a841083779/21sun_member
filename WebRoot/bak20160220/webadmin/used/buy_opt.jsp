...
String urlpath="../used/buy_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><div align="right" class="STYLE1"><strong><span class="STYLE1">会员编号</span>：</strong></div></td>
    ...
    <tr>
      <td align="right" nowrap class="list_left_title">联系电话：</td>
    ...
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input type="text" id="zd_pubdate" name="zd_pubdate" value="<%=Common.getToday("yyyy-MM-dd HH:mm:ss",0)%>" size="20" maxlength="20" />
      <input name="zd_extradate" type="hidden" id="zd_extradate"></td>
      </td>
    </tr>
    <tr>
    ...
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
          ...
          <input type="button" name="mit2" value="导入至供应" style="cursor:pointer" class="tijiao" onClick="javascript:doimport();" />
