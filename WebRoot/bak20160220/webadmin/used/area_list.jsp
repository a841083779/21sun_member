...
//=====页面属性====
String tablename="member_area";
String pageSubName = "area_opt.jsp";
//======================
...
<form action="" method="get" name="theform" id="theform">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 20px; margin-right: 20px;">
          <tr>
            <td width="20%" bgcolor="e8f2ff" align="center"><strong>地域名称</strong></td>
            <td width="20%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>经度</strong></span></div></td>
            <td width="20%" align="center" bgcolor="e8f2ff"><strong>纬度</strong></td>
            <td width="20%" align="center" bgcolor="e8f2ff"><strong>放大级别</strong></td>
...
%>
          <tr <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
          	<td height="30" align="left"><%=rs.getString("name") %></td>
          	<td align="right"><%=rs.getString("longitude") %></td>
          	<td align="right"><%=rs.getString("latitude") %></td>
          	<td align="center"><%=rs.getString("zoom") %></td>
          	<td align="center">
