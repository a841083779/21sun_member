...
//=====页面属性====
String pagename="brand_opt.jsp";
String mypy="used_brand";
String titlename="品牌管理";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));

String urlpath="../used/brand_opt.jsp";
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    <tr>
      ...
      <td  width="80%">
     	 <input name="zd_brand" type="text" id="zd_brand" size="50" />
      </td>
    </tr>
	 <tr>
    	<td width="20%">
      ...
      <td  width="80%">
     	 <input name="zd_en_name" type="text" id="zd_en_name" size="50" />
      </td>
    </tr>
 	 <tr>
    	<td>
      ...
      <td>
     	 <input name="zd_brand_name" type="text" id="zd_brand_name" size="50" />
      </td>
    </tr>
    <tr >
