...
//=====页面属性====
String tablename="aboutus_pic";
String pageSubName="company_photos_opt.jsp";
//======================
...
StringBuffer query =new StringBuffer("select * from "+tablename+" where catalog_no='701101'");
//得到参数
String findTitle=Common.getFormatStr(request.getParameter("findTitle"));
if(!findTitle.equals("")){
	query.append(" and title like '%"+findTitle+"%'");
}
String findCatalog=Common.getFormatStr(request.getParameter("findCatalog"));
if(!findCatalog.equals("")){
	query.append(" and sub_catalog_no = '"+findCatalog+"'");
}
try{
...
<form action="" method="get" name="theform" id="theform">
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="65%" align="center" nowrap="nowrap"><span class="title1">标题：
              ...
              <select name="findCatalog" id="findCatalog">
                <option value="">--请选择类别--</option>
			<option value="1" <%if(findCatalog.equals("1"))out.print("selected");%>>公司图片－办公区</option>
			<option value="2" <%if(findCatalog.equals("2"))out.print("selected");%>>公司图片－会议室</option>
			<option value="3" <%if(findCatalog.equals("3"))out.print("selected");%>>公司图片－活动室</option>
			<option value="4" <%if(findCatalog.equals("4"))out.print("selected");%>>公司图片－外景</option>
			<option value="5" <%if(findCatalog.equals("5"))out.print("selected");%>>活动剪影－旅游</option>
			<option value="6" <%if(findCatalog.equals("6"))out.print("selected");%>>活动剪影－运动会</option>
			<option value="7" <%if(findCatalog.equals("7"))out.print("selected");%>>活动剪影－聚餐</option>
			<option value="8" <%if(findCatalog.equals("8"))out.print("selected");%>>活动剪影－训练</option>
			<option value="9" <%if(findCatalog.equals("9"))out.print("selected");%>>活动剪影－公益活动</option>
			<option value="10" <%if(findCatalog.equals("10"))out.print("selected");%>>活动剪影－公司活动</option>
			<option value="11" <%if(findCatalog.equals("11"))out.print("selected");%>>活动剪影－行业活动</option>
              </select>
              </span>
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="45%" bgcolor="e8f2ff"><strong>标题</strong></td>
			 <td width="14%" align="center" bgcolor="e8f2ff"><strong>所属类别</strong></td>
            <td width="11%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>日期</strong></span></div></td>
 ...
 while (rs!=null && rs.next()){
   k=k+1;
   String img = Common.getFormatStr(rs.getString("img"));
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            <td height="30" align="center"><%=k%></td>
            <td><%=Common.getFormatStr(rs.getString("title"))%></td>
			 <td><%=Common.getFormatStr(rs.getString("catalog_name"))%></td>
