    ...
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="15">
              <input type="button" name="b_add" value="增加" onclick="openWin('role_opt.jsp','sell',450,300)"/>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="24%" align="center" nowrap="nowrap" bgcolor="e8f2ff"><strong>会员分类</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center" nowrap="nowrap"><span class="p92j"><a href="javascript:deleteData('<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('role_opt.jsp?myvalue=<%=rs.getString("id")%>','member',450,300)">修改</a> &nbsp;&nbsp; <a href="#" onclick="openWin('role_purview_opt.jsp?role_num=<%=rs.getString("role_num")%>&name=<%=URLEncoder.encode(rs.getString("role_name"),"utf-8")%>','member',450,300)">设定权限</a></span></td>
          </tr>
          <%
}
%>
