...
//=====页面属性====
String pagename="role_opt.jsp";
String mypy="member_role";
String titlename="";
...
String urlpath="../member/role_list.jsp";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="list_border_bg">
    ...
    <tr>
      <td height="22" colspan="2" align="center" bgcolor="#FFFFFF" ><input type="button" name="Submit" value="保存" onClick="submityn()">
          ...
          <input name="urlpath" type="hidden" id="urlpath" value="/webadmin/member/role_opt.jsp?myvalue=<%=myvalue%>">
