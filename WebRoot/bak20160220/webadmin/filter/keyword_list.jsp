      ...
      <td background="../images/admin/oper_table_bg.gif"><div align="center">
          <table width="97%"  border="0" cellpadding="0" cellspacing="0" id="table5">
            <tr>
              ...
              <%}%>
               关键词 ：
                <input name="keyword" type="text" id="keyword" value="<%=keyword%>" size="10">
  ...
  <div align="center">
    <table width="97%" border="0" cellpadding="4" cellspacing="1" class="table_border_bg" style="background-color: #717EA2" id="table2">
      <tr bgcolor="#e8f2ff">
        ...
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">标识</strong></td>
        <td width="8%" nowrap class="title1" bgcolor="#e8f2ff"><strong class="list_border_bg">是否启用</strong></td>
...
%>
      <tr  <%=j%2==0?"bgcolor='#E8EAF0'":"bgcolor='#FFFFFF'"%>>
        ...
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("keyword"))%></td>
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("flag")).equals("1")?"关键词":"IP"%></td>
        <td height="22" nowrap ><%=Common.getFormatStr(rs.getString("is_use")).equals("1")?"是":"否"%></td>
