...
if(pool==null){
	pool = new PoolManager();
	 ...
	 String tablename="exhibition_bobao";
	
	 
	 String pageSubName = "exhibition_img_edit.jsp";
	...
	try {
		...
		String query = "select * from "+tablename+" "+searchStr+"  order by order_no,id desc";
      ...
      <td valign="top">
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<td height="15" width="10%" align="left">
           		 <a href="#" onclick="openWin('<%=pageSubName%>','win',800,600)">增加</a>
            </td>
          </tr>
        </table>
