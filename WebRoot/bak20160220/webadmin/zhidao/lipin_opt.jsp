...
<%//=====页面属性====
String pagename="lipin_opt.jsp";
String mypy="zhidao_lipin";
String titlename="礼品管理";
...
String urlpath="../zhidao/lipin_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input type="radio" id="zd_show" name="zd_show" value="1" checked="checked">
        是
        <input type="radio" id="zd_show" name="zd_show" value="0">
        否    </td>
    </tr>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>市场价格：</strong></td>
      <td class="list_cell_bg"><input name="zd_price" type="text" id="zd_prive" size="60" maxlength="40" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>金币数量：</strong></td>
      <td class="list_cell_bg"><input name="zd_golds" type="text" id="zd_golds" size="60" maxlength="40" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>图　　片：</strong></td>
      <td class="list_cell_bg"><input name="zd_image" type="text" id="zd_image" size="60" maxlength="40" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr >
