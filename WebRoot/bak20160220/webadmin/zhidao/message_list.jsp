...
//=====页面属性====
String tablename="zhidao_message";
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('../other/opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)">查看</a></span></div></td>
          </tr>
          <%
}
%>
