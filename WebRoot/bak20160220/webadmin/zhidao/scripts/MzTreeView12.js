...
function MzTreeView(Tname)
{
  ...
  this.toString = function()
  {
    ...
    this.setStyle();
    this.load("-1");
    var rootCN = this.node["-1"].childNodes;
    var str = "<A id='"+ this.name +"_RootLink' href='#' style='DISPLAY: none'></A>";
    
    if(rootCN.length>0)
    {
      this.node["-1"].hasChild = true;
...
{
  var RCN = this.node["-1"].childNodes;
...
MzTreeView.prototype.nodeToHTML = function(node, AtEnd)
{
  ...
  var id   = node.id;
  var HCN  = node.hasChild, isRoot = node.parentId=="-1";
...
MzTreeView.prototype.focusClientNode      = function(id)
{
 try {
  ...
  if(!this.currentNode) this.currentNode=this.node["-1"];
...
MzTreeView.prototype.focus = function(sourceId, defer)
{
  ...
  var root = this.node["-1"], len = path.length;
  for(var i=1; i<len; i++)
  {
    if(root.hasChild)
    {
...
MzTreeView.prototype.upperNode = function()
{
  ...
  if(this.currentNode.id=="-1" || this.currentNode.parentId=="-1") return;
...
MzTreeView.prototype.pervNode = function()
{
  ...
  if(e.id=="-1") return; var a = this.node[e.parentId].childNodes;
...
{
  var e = this.currentNode; if(!e) e = this.node["-1"];
...
MzTreeView.prototype.expandAll = function()
{
  ...
  if(this.node["-1"].childNodes.length==0) return;
  var e = this.node["-1"].childNodes[0];
  var isdo = t = false;
  while(e.id != "-1")
  {
