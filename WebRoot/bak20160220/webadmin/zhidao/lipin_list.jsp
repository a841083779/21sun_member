...
//=====页面属性====
String tablename="zhidao_lipin";
String pageSubName="lipin_opt.jsp";
//======================
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="54%" bgcolor="e8f2ff"><strong>礼品名</strong></td>
            <td width="10%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>日期</strong></span></div></td>
            <td width="7%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>数量</strong></span></div></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><%=Common.getFormatInt(rs.getString("num"))%></div></td>
            <td align="center"><div align="center"><span class="p92j"><%=Common.getFormatStr(rs.getString("show")).equals("1")?"显示":"不显示"%></span></div></td>
