...
<%//=====页面属性====
String pagename="option_opt.jsp";
String mypy="zhidao_option";
String titlename="设置管理";
...
String urlpath="../zhidao/option_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input type="text" id="zd_image" name="zd_image" size="20" maxlength="20"  /></td>
      </td>
    </tr>
    <tr >
