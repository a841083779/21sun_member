...
<%//=====页面属性====
String pagename="type_opt.jsp";
String mypy="zhidao_type";
String titlename="类别管理";
...
String urlpath="../zhidao/type_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="type_save.jsp" method="post" name="theform" id="theform" >
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>类　　名：</strong></td>
      <td class="list_cell_bg"><input name="zd_name" type="text" id="zd_name" size="60" maxlength="40" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>层级目录：</strong></td>
      <td class="list_cell_bg"><input name="zd_nodeid" type="text" id="zd_nodeid" size="60" maxlength="40" class="required" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>品牌图片：</strong></td>
      <td class="list_cell_bg"><input name="zd_image" type="text" id="zd_image" size="60" maxlength="40" >
        <font color="#FF0000">*</font></td>
    </tr>
    <tr >
