...
if(id==null||id.equals("")||id.equals("0")){
	sql="insert into zhidao_money (add_user,add_ip,add_date,num,type,money_user,men_no) values "
	+"('admin','"+ip+"',convert(datetime,'"+date+"'),"+num+","+type+",0,'admin')";
}else{
	sql="update zhidao_money set add_user='admin',add_ip='"+ip+"',add_date=convert(datetime,'"+date+"'),num="+num+",type="+type+",money_user=0,men_no='admin' where id="+id;
}
int result = 0;
