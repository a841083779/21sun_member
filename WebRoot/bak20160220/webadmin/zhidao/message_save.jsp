...
String parent=Common.getFormatStr(request.getParameter("zd_return"));
String par=Common.getFormatStr(request.getParameter("zd_point_user"));
//=====生成静态页的相关控制===
String zd_catalog_no=Common.getFormatStr(request.getParameter("zd_catalog_no"));
String sql;
if(id==null||id.equals("")||id.equals("0")){
	sql="insert into zhidao_post (add_ip,add_date,post_type,context,parent,men_no) values ('"+ip+"',convert(datetime,'"+date+"'),1,"
		+"'"+context+"',"+par+",'admin')";
}else{
