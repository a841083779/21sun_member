...
//=====页面属性====
String tablename="zhidao_type";
String pageSubName="type_opt.jsp";
//======================
...
if(!findTitle.equals("")){
	query.append(" and name like '%"+findTitle+"%'");
}
String findNode=Common.getFormatStr(request.getParameter("findNode"));
if(!findNode.equals("")){
	query.append(" and nodeid like '"+findNode+"%'");
}
try{
    ...
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <span class="title1">
              父级：
              <input name="findNode" type="text" id="findNode" value="<%=findNode%>" />
              名称：
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" height="30" align="center" bgcolor="e8f2ff"><strong>类别层级</strong></td>
            <td width="56%" bgcolor="e8f2ff"><strong>名称</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            <td height="30" align="left"><span style="margin-left:<%=rs.getString("nodeid").length()*3 %>px"><%=Common.getFormatStr(rs.getString("nodeid"))%></span></td>
            <td><a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)"><%=Common.getFormatStr(rs.getString("name"))%></a></td>
