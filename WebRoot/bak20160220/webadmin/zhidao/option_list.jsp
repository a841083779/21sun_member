...
//=====页面属性====
String tablename="zhidao_option";
String pageSubName="option_opt.jsp";
//======================
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="10%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>图片</strong></span></div></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><%=Common.getFormatStr(rs.getString("image"))%></div></td>
            <td align="center"><div align="center"><span class="p92j"> &nbsp;&nbsp; <a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>','win',800,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
