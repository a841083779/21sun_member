...
//=====页面属性====
String tablename="zhidao_renwu";
String pageSubName="renwu_opt.jsp";
//======================
...
query.append("order by overtime");
try{
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="10%" align="center" bgcolor="e8f2ff"><div align="center">查看问题</div></td>
            <td width="10%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>结束日期</strong></span></div></td>
            <td width="7%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>开始日期</strong></span></div></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><a href="other_list.jsp?rid=<%=rs.getString("id")%>&title=<%=Common.encryptionByDES(rs.getString("title")) %>">查看</a></div></td>
            <td align="center"><div align="center"><%=Common.getFormatDate("yyyy-MM-dd",rs.getDate("overtime"))%></div></td>
