...
String pageSubName="post_opt.jsp";
//======================
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="42%" bgcolor="e8f2ff"><strong>标题</strong></td>
            ...
            <td width="11%" align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>操作</strong></span></div></td>
          </tr>
          <tr>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><div align="center"><span class="p92j"><a href="javascript:otherDeleteData('opt_delete.jsp','<%=Common.encryptionByDES(rs.getString("id"))%>','<%=Common.encryptionByDES(tablename)%>');">删除</a> &nbsp;&nbsp; <a href="#" onclick="openWin('<%=pageSubName%>?myvalue=<%=rs.getString("id")%>?type=<%=rs.getString("type") %>','win',800,600)">修改</a></span></div></td>
          </tr>
          <%
}
%>
