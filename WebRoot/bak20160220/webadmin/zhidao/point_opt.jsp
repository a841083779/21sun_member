...
<%//=====页面属性====
String pagename="point_opt.jsp";
String mypy="zhidao_integral";
String titlename="积分管理";
...
String urlpath="../zhidao/point_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="point_save.jsp" method="post" name="theform" id="theform" >
    <tr>
    ...
    <tr>
      <td align="right" nowrap class="list_left_title"><strong>积分类型：</strong></td>
      <td><select name="zd_type">
      <%=Common.option_str(pool3,"zhidao_point_type","id,name", "type=0","id", 1)%>
      </select>
        <font color="#FF0000">*</font></td>
    </tr>
    <tr>
