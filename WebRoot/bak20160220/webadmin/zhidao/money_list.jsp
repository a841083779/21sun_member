...
//=====页面属性====
String tablename="zhidao_money";
String pageSubName="money_opt.jsp";
//======================
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="46%" bgcolor="e8f2ff"><strong>财富数量</strong></td>
            <td width="12%" bgcolor="e8f2ff"><strong>所属用户</strong></td>
            <td width="10%" bgcolor="e8f2ff"><strong>财富类型</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <%
            	if(rs.getString("type").equals("10")){
            		%><td>首次登录</td><%
            	}
            	if(rs.getString("type").equals("11")){
            		%><td>付出奖赏</td><%
            	}
            	if(rs.getString("type").equals("12")){
            		%><td>获得奖赏</td><%
            	}
            	if(rs.getString("type").equals("13")){
            		%><td>系统奖励</td><%
            	}
             %>
