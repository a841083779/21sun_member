...
<%
	//根据ip获得地址
	String mypy = "sell_buy_market_ago";
...
<div class="loginlist_right">
  ...
  <%
			...
			%>
  <div class="formTable">
    <form action="<% if(isPub){  %>opt_save_update_freemaker_ago_randsb.jsp<%}else{ %><%} %>" method="post" name="theform" id="theform" submited="true">
...
function set_formxx(val){
	if(val!=null && val!=""){
	 $('#getxinxi').attr("src","set_formxx_freemaker_ago.jsp?mypy="+encodeURIComponent('<%=mypy%>')+"&paraName=myvalue&paraValue="+encodeURIComponent(val));
	}
}
<%
if(!myvalue.equals("")){
