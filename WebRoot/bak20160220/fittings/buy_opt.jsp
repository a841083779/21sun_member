 ...
 function onloadAjax(){
		...
		success: function(msg){ 
				...
				if(pubCount>=30){	
					...
					alert("您今天已发布了"+pubCount+"条求购信息，已经达到最大发布数,自动跳转至列表页！");
...
<div class="loginlist_right" style="height:520px">
  <div class="loginlist_right2"><span class="mainyh">发布配套件求购信息</span>&nbsp;&nbsp;<strong style="cursor:pointer;"> <a href="buy_list.jsp">>>返回</a></strong></div>
  <div class="loginlist_right1">
    ...
    <table width="95%" border="0" align="center" class="tablezhuce">
      <form action="opt_save_update.jsp" method="post" name="theform" id="theform">
		...
		<tr id="partSortTr">
          <td  class="right"nowrap="nowrap"> <span class="grayb">求购类型：</span></td>
          <td height="22" class="list_cell_bg"><input type="radio" id="buy_type1" name="zd_buy_type" value="10" /style="border:0"; >
            紧急求购
            <input type="radio" id="buy_type2" name="zd_buy_type" value="11" style="border:0"; checked="checked"/>
            普通求购
            <input type="radio" id="buy_type3" name="zd_buy_type" value="12" style="border:0";/>
            寻求代理
			<input type="radio" id="buy_type4" name="zd_buy_type" value="13" style="border:0";/>
            采购信息</td>
        </tr>
		<tr>
