      ...
      <form action="opt_save_update.jsp" method="post" name="theform" id="theform">
        ...
        <tr>
          ...
          <td ><input name="zd_img" id="zd_img" type="hidden" value="" />
		   <input name="zd_img_1" id="zd_img_1" type="hidden" value="" />
            <span id="txt_zd_img"></span><span  id="ifr_zd_img">
            <iframe id="ifr2_zd_img" scrolling="no" frameborder="0" width="100%" height="28" src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=27&dir=fittings&fieldname=zd_img&smallpic=zd_img_1" ></iframe>
            </span></td>
        </tr>
		<tr>
