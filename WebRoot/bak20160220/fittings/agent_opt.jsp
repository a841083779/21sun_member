...
<div class="loginlist_right">
  <div class="loginlist_right2"><span class="mainyh">发布配套件代理招商信息</span>&nbsp;&nbsp;<strong style="cursor:pointer;"> <a href="agent_list.jsp">>>返回</a></strong></div>
