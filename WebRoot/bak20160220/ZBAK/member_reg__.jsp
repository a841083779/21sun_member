...
<div class="registForm">
  <div class="registBg">
    ...
    <div class="registTable">
      ...
      <input type="hidden" id="zd_city" name="zd_city"  />
		...
		<div class="diu" id="passw2_dui" style="display:none"></div>
          ...
          <tr>
          	<th><font>*</font> 手机：</th>
          	<td colspan="2"><input name="per_phone" type="text" class="ri" id="per_phone" onfocus="this.className='regiHover'" onblur="formyanzheng('per_phone')"/>
    ...
    <div style="position:absolute; left:22px; top:63px;"><a title="铁臂兄弟连感恩十周年，耀世上线" target="_blank" href="http://ad.21-sun.com/link_to.jsp?paras=1,0,100020&url=http://www.wajueji.com/"><img width="182" height="477" alt="铁臂兄弟连感恩十周年，耀世上线" src="http://www.21-sun.com/homepic/tb/tb_member_regist.gif"></a></div>
  </div>
  <div class="clear"></div>
</div>
