...
if (memberInfo != null) 
{
	...
	if(lottery!=null){
		...
		if (rs != null && rs.next()) {
			...
			String lingJiangString = Choujiang.getJiangPin(lottery,phoneString);
...
function setFocus()
{
	document.getElementById('mem_no1').focus();
}
function showPwd()
{
...
<div class="registForm">
  <div class="registBg">
    ...
    <div class="clear"></div>
    <form id="theform1" name="theform1" method="post" action="member_login_action_jiang.jsp"  target="_parent">
    <div style="background:url(images/bj11.jpg); height:47px;">
    	<div style="float:left; height:47px; line-height:47px;">&nbsp;&nbsp;&nbsp;&nbsp;用户名：<input type="text" id="mem_no1" name="mem_no1" size="20" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码：<input type="password" name="passw1" id="passw1" size="20" />&nbsp;&nbsp;&nbsp;&nbsp;</div>
    <div style=" height:37px;margin-top:10px; float:left"><img src="images/login.jpg" height="28" width="91"  onclick="tjYanzheng();" style="cursor:pointer" alt="中国工程机械商贸网" /></div></div>
    </form>
...
function tjYanzheng(){
  if(document.theform1.mem_no1.value==""){
    alert("请输入您的用户名！");
	document.theform1.mem_no1.focus();
	return false;
  }else if(document.theform1.passw1.value==""){
    alert("请输入您的密码！"); 
	document.theform1.passw1.focus();
	return false;
  }else{
