    ...
    <form id="theform" name="theform" method="post" action="member_reg_action.jsp"  onsubmit="return regYanzheng();" >
      <table width="95%" align="center" border="0" class="tablezhuce">
        ...
        <tr>
          ...
          <td colspan="2"><textarea name="comp_intro" rows="5" class="moren" id="comp_intro" style="width:300px" onblur="formyanzheng('comp_intro')" onkeyup="if((this.value).length&gt;1150){ this.value=(this.value).substr(0,1150);alert('描述请控制在1150个汉字以内。');}"></textarea>
            &nbsp;
