...
#pageflip { position:absolute; top:0px; right:0px; z-index:10000;}
#pageflip img { position:absolute; top:0px; right:0px; z-index:10001; width:63px; height:63px; ms-interpolation-mode:bicubic;}
#pageflip .msg_block { position:absolute; top:0px; right:0px; background:url(images/subscribe.gif) no-repeat right top; overflow:hidden; width:63px; height:63px;}
.center1_2 td { white-space:nowrap;}
.center1_2 table { margin:0px auto;}
</STYLE>
<!-- 配件2.0--end-->
</head>
<body>
<!-- 配件2.0--begin-->
<div id="pageflip"><A href="http://www.21-sun.com/service/xitong/peijianguanli_hbs.htm" target="_blank"><IMG src="images/page_flip.png" alt="配件经营好帮手V2.0" width="307" height="319"></A>
...
<!--对联广告-->
<div id="ads01">
<a href="http://ad.21-sun.com/link_to.jsp?paras=0,0,100030&url=news.21-sun.com/special/breaker_meeting/index.htm" target="blank" title="2013年首届中国破碎锤行业研讨会" onmouseover="document.getElementById('ads01').className='ads_hover';document.getElementById('ads02').className='ads_hover'" onmouseout="document.getElementById('ads01').className='';document.getElementById('ads02').className=''" style="display:block;"><img src="http://www.21-sun.com/homepic/breaker/dl_x.jpg" width="42" height="330" alt="2013年首届中国破碎锤行业研讨会" class="ads_small" /><img src="http://www.21-sun.com/homepic/breaker/left_d.jpg" width="95" height="330" alt="2013年首届中国破碎锤行业研讨会" class="ads_big" /></a>
...
<div id="ads02">
<a href="http://ad.21-sun.com/link_to.jsp?paras=0,0,100030&url=news.21-sun.com/special/breaker_meeting/index.htm" target="blank" title="2013年首届中国破碎锤行业研讨会" onmouseover="document.getElementById('ads01').className='ads_hover';document.getElementById('ads02').className='ads_hover'" onmouseout="document.getElementById('ads01').className='';document.getElementById('ads02').className=''" style="display:block;"><img src="http://www.21-sun.com/homepic/breaker/dl_x.jpg" width="42" height="330" alt="2013年首届中国破碎锤行业研讨会" class="ads_small" /><img src="http://www.21-sun.com/homepic/breaker/right_d.jpg" width="95" height="330" alt="2013年首届中国破碎锤行业研讨会" class="ads_big" /></a>
