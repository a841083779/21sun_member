    ...
    <div class="center1_2">
      <form id="theform" name="theform" method="post" action="member_login_action.jsp" onkeydown="KeyDown(event)" target="_parent">
        <table width="85%" border="0" align="center">
          ...
          <tr>
            <td><span class="grayb">关联帐号：</span></td>
            <td valign="middle">
            <span><a href="https://api.weibo.com/oauth2/authorize?client_id=3516048995&redirect_uri=http://member.21-sun.com/openplatform/sina.jsp&response_type=code" target="_parent"> <img src="/images/sina.png"/>新浪微博</a></span>
	       &nbsp; <span><a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100365337&scope=all&redirect_uri=http://member.21-sun.com/openplatform/qq.jsp" target="_parent"><img src="/images/qq.png" style=" vertical-align:middle; "/> QQ</a></span> </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
