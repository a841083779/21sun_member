...
//====查找db2中最大的id===
String tempdbId[][]=DataManager.fetchFieldValue(pool1,"rent_info_test", "max(convert(bigint,db2id))", "");
...
sql="insert into rent_info_test(mem_no,mem_name,PUBDATE,PUBDAYS,is_pub,CLICKED,TITLE,MODEL,BRAND,CATEGORY,SUBCATEGORY,PROVINCE,CITY,PRICE,AMOUNT ,content,IMG,CLASS,sort,ISDONE,db2id,catalog_no)values('"+Common.getFormatStr(rs.getString(1))+"','"+Common.getFormatStr(rs.getString(1))+"','"+Common.getFormatDate("yyyy-MM-dd",rs.getDate(2))+"','"+Common.getFormatStr(rs.getString(3))+"','"+Common.getFormatStr(rs.getString(4))+"','"+Common.getFormatStr(rs.getString(5))+"','"+Common.getFormatStr(rs.getString(6))+"','"+Common.getFormatStr(rs.getString(7))+"','"+Common.getFormatStr(rs.getString(8))+"','"+Common.getFormatStr(rs.getString(9))+"','"+Common.getFormatStr(rs.getString(10))+"','"+Common.getFormatStr(rs.getString(11))+"','"+Common.getFormatStr(rs.getString(12))+"','"+Common.getFormatStr(rs.getString(13))+"','"+Common.getFormatStr(rs.getString(14))+"','"+Common.getFormatStr(rs.getString(15)).replace("\r\n","<br>")+"','"+temp_img+"','"+Common.getFormatStr(rs.getString(17))+"','"+Common.getFormatStr(rs.getString(18))+"','"+Common.getFormatStr(rs.getString(19))+"','"+Common.getFormatStr(rs.getString(20))+"','700701')";

dataManager1.dataOperation(conn1, sql);}
sql="";
}
//======数据导入完了之后，执行存贮过程===
sql="exec update_rent_info_province "+db2Id;
DataManager.dataOperation(conn1,sql);
