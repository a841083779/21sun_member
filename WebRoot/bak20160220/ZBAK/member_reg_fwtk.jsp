...
<title>中国工程机械商贸网的服务条款 - 中国工程机械商贸网</title>
...
<div class="weizhi">
  <div class="weizhi_1">您的位置 >> 我的商贸网 >> 中国工程机械商贸网的服务条款</div>
</div>
<div class="center">
  <!--
  <div class="zhuce">
  ...
  <br />
    ...
    商贸网有权在必要时修改服务条款，商贸网服务条款一旦发生变动，将会在重要页面上提示修改内容。如果不同意所改动的内容，用户可以主动取消获得的网络服务。如果用户继续享用商贸网网络服务，则视为接受服务条款的变动。商贸网保留随时修改其服务体系和价格而不需通知用户的权利，商贸网修改其服务和价格体系之前用户就具体服务与商贸网达成协议并已按照约定交纳费用的，商贸网将按照已达成的协议执行至已交纳费用的服务期期满。</p>
    ...
    6-6用户保证其使用商贸网服务时将遵从国家、地方法律法规、行业惯例和社会公共道德，不会利用商贸网提供的服务进行存储、发布、传播如下信息和内容：违反国家法律法规政策的任何内容（信息）；违反国家规定的政治宣传和/或新闻信息；涉及国家秘密和/或安全的信息；封建迷信和/或淫秽、色情、下流的信息或教唆犯罪的信息；博彩有奖、赌博游戏；违反国家民族和宗教政策的信息；防碍互联网运行安全的信息；侵害他人合法权益的信息和/或其他有损于社会秩序、社会治安、公共道德的信息或内容。用户同时承诺不得为他人发布上述不符合国家规定和/或本服务条款约定的信息内容提供任何便利，包括但不限于设置URL、BANNER链接等。用户承认商贸网有权在用户违反上述时有权终止向用户提供服务并不予退还任何款项，因用户上述行为给商贸网造成损失的，用户应予赔偿。</p>
    ...
    8-3 用户申请成为商贸网会员后应当遵守商贸网不时作出的关于反垃圾邮件的决议，用户承诺不会利用商贸网的服务进行任何涉及垃圾邮件的行为，包括但不限于用户利用商贸网服务器发送垃圾邮件；用户发送垃圾邮件中包含商贸网服务器或IP地址的相关信息；用户发送的垃圾邮件中包含其在商贸网注册域名信息等可能使国内及国际反垃圾邮件组织认为商贸网或商贸网用户与垃圾邮件事件有关的内容或信息。用户理解一旦发生垃圾邮件事件将对商贸网及其所有用户造成不可挽回的巨大损失，因此商贸网发现用户有涉及垃圾邮件的行为将立即停止为该用户提供任何服务，无论用户在商贸网享有的服务是收费或者免费亦无论该服务是否直接与发送垃圾邮件的行为相关，商贸网有权在用户涉及垃圾邮件事件时取消该用户的商贸网会员资格并保留对因用户涉及垃圾邮件给商贸网造成损失索赔的权利。</p>
