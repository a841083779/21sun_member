...
<script language="javascript" type="text/javascript" src="/scripts/lhgdialog/lhgcore.min.js"></script>
<script language="javascript" type="text/javascript" src="/scripts/lhgdialog/lhgdialog.min.js"></script>
...
%>
    ...
    <%}else if(isLogon==-3){%>
    用户名或密码不正确，<a href="member_login.jsp" class="blue14">请点击此处<b>重新登录</b>；</a>或者您1年以上没有登录，系统自动注销了您的帐号，<a class="blue14"  href="javascript:openDialog('','/tools/data/active_login.jsp?memNo=<%=memNo%>',388,288);">请点击此处<b>激活</b>。</a>
    <%}else if(isLogon==-1){%>
