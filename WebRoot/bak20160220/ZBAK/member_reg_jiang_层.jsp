...
String tiaozhuanFlag = "";
String lingJiangString ="";

//对数据报告进行处理--begin
String lottery = Common.getCookies(request,"lottery");
String typeStr = Common.getFormatStr(request.getParameter("type"));
if(!typeStr.equals("") && typeStr!=null && lottery!=null){
	Common.createCookie(response,"lottery",typeStr,(100*24*60*60));
	lottery = typeStr;
}
//对数据报告进行处理--end
...
if (memberInfo != null) 
{
	...
	if(lottery!=null){
		//
		String seSql = "select jiang,per_phone,per_email from member_info where mem_no=?";
		conn = pool.getConnection();
		pstmt = conn.prepareStatement(seSql);
		pstmt.setString(1, sessionMemNo);
		...
		if (rs != null && rs.next()) {
			...
			//组装update语句
			String upSql = "update member_info set jiang='"+jiang+","+lottery+",' where mem_no='"+sessionMemNo+"'";
			System.out.println(upSql);
			DataManager.dataOperation(conn, upSql);
			
			//清除中奖cookie
			Common.createCookie(response,"lottery","",0);
			String phoneString = rs.getString("per_phone");
			String perEmailString = rs.getString("per_email");
			lingJiangString = Choujiang.getJiangPin(lottery,phoneString);
			if(perEmailString.equals("")||perEmailString==null){
				tiaozhuanFlag = "1";		
			}else{
				tiaozhuanFlag = "2";
			}
...
<script src="thickbox/thickbox.min.js" type="text/javascript"></script>
<!--thickbox-->
...
<%
 if(tiaozhuanFlag.equals("1")){
	 System.out.println("---------------1---------------");
%>
	window.onload=function()
	{
		tb_show("","#TB_inline?height=300&width=500&inlineId=myOnPageContent&modal=false", null);
	}
<% 
 }else if(tiaozhuanFlag.equals("2")){
	 System.out.println("---------------2---------------");
%>
		alert("<%=lingJiangString%>"+"\r\n详情请访问：http://news.21-sun.com/grateful/index.jsp");
		window.location.href="/manage/memberhome.jsp";
<% 	 
 }else if(tiaozhuanFlag.equals("3")){
...
<div class="registForm">
  <div class="registBg">
    <div class="registTop">
      <h3>如果您是21-sun会员，请直接<a href="/member_login_jiang.jsp" class="blue">登录</a>领取奖品；如果您还不是21-sun会员，请先完善以下资料领取奖品。</h3>
    </div>
    <div class="clear"></div>
    <div style="background:url(images/bj11.jpg); height:47px;">
    	<div style="float:left; height:47px; line-height:47px;">&nbsp;&nbsp;&nbsp;&nbsp;用户名：<input type="text" name="T1" size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码：<input type="text" name="T1" size="20">&nbsp;&nbsp;&nbsp;&nbsp;</div>
    <div style=" height:37px;margin-top:10px; float:left"><img src="images/login.jpg" height="28" width="91" alt="中国工程机械商贸网" /></div></div>
    <div class="registTable">
      <form id="theform" name="theform" method="post" action="member_reg_action_jiang.jsp"  onsubmit="return regYanzheng_jiang();" >
      ...
      <input type="hidden" id="zd_city" name="zd_city"  />
		...
		<div class="diu" id="passw2_dui" style="display:none"></div>
          ...
          <tr>
              <th><font>*</font> 手机号：</th>
              <td colspan="2"><input name="per_phone" type="text" class="ri" id="per_phone"  onblur="formyanzheng('per_phone')" onFocus="showText('per_phone')"/>
                <div class="diu" id="per_phone_dui" style="display:none"></div>
                <div class="cuo" id="per_phone_cuo" style="display:none"></div>
                <div class="cuo1" id="per_phone_cuo_info" style="display:none"></div>
                <div id="per_phone_show_info" style="display:none;width:100%; float:left;">请如实填写，方便客户联系，我们将保障您的信息隐私。</div>
                </td>
        	</tr>
           <tr>
              <th><font>*</font>邮箱：</th>
              <td colspan="2"><input name="per_email" type="text" class="ri" id="per_email" onBlur="formyanzheng('per_email')" onFocus="showText('per_email')"/>
                <div class="diu" id="per_email_dui" style="display:none"></div>
                <div class="cuo" id="per_email_cuo" style="display:none"></div>
                <div class="cuo1" id="per_email_cuo_info" style="display:none"></div>
                <div id="per_email_show_info" style="display:none;width:100%; float:left;">请输入您的常用邮箱，推荐使用QQ邮箱。</div>
                </td>
            </tr>
          <tr>
            <th height="30"><font>*</font> 验证码：</th>
            <td colspan="2"><input type="text" name="rand" id="rand" class="ri" style="width:106px;" onKeyUp="formyanzheng('rand')"/>
...
<div id="myOnPageContent" style="display:none;">
  <div class="message" style="background-color: white; text-align: center;">
    <p style="height:100px; line-height:100px; width:500px; overflow:hidden;">请完善您的资料，以便完成抽奖流程！</p>
  </div>
</div>
</body>
