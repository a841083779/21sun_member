...
function tjYanzheng(){
	if(document.theform.mem_no1.value==""){
		alert("用户名不能为空！");
		document.theform.mem_no1.focus();
		return false;
	}else if(document.theform.passw1.value==""){
		alert("密码不能为空！");
		document.theform.passw1.focus();
		return false; 
...
<div class="center">
  <div class="center1">
    ...
    <div class="center1_2">
      <form id="theform" name="theform" method="post" action="member_login_action_jiang.jsp" onkeydown="KeyDown(event)" target="_parent">
        <table width="85%" border="0" align="center">
          <tr>
            <td width="20%"><span class="grayb">用户名：</span></td>
            <td width="51%"><label>
             <input name="mem_no1" type="text" id="mem_no1" style="width:140px" maxlength="50"/>
              </label></td>
          ...
          <tr>
            ...
            <td><input name="passw1" type="password" id="passw1"  style="width:140px" maxlength="50"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td height="40px"><!--<a href="#" class="blue14">忘记密码？</a>--> <a href="member_reg_jiang.jsp" class="blue14">马上免费注册</a></td>
            <td>&nbsp;</td>
          </tr>
        </table>
      </form>
