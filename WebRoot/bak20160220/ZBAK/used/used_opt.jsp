...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      ...
      <td class="list_cell_bg"><select name="zd_class" id="zd_class">
    ...
    <tr>
      ...
      <td class="list_cell_bg"><select name="zd_category" id="zd_category" >
          ...
          <option value="吊机">吊机</option>
          <option value="发电/动机">发电/动机</option>
          <option value="工具">工具</option>
          <option value="混凝土车">混凝土车</option>
          <option value="搅拌站">搅拌站</option>
          ...
          <option value="旋挖机">旋挖机</option>
          <option value="压路机">压路机</option>
          <option value="压缩机">压缩机</option>
          <option value="载重车">载重车</option>
          <option value="桩工机械">桩工机械</option>
          <option value="装载机">装载机</option>
          <option value="钻机">钻机</option>
        </select>
		<input type="hidden" name="zd_subcategory" id="zd_subcategory" value=""></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="list_cell_bg"><input name="zd_extradate" type="text" id="zd_extradate" value="<%=Common.getToday("yyyy-MM-dd",0)%>" onFocus="calendar(event)"></td>
    </tr>
    ...
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input name="zd_img2" type="text" id="zd_img2" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_img2','upload',480,150)"></td>
    </tr>
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input name="zd_img3" type="text" id="zd_img3" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_img3','upload',480,150)"></td>
    </tr>
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input name="zd_img4" type="text" id="zd_img4" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_img4','upload',480,150)"></td>
    </tr>
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input name="zd_img5" type="text" id="zd_img5" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_img5','upload',480,150)"></td>
    </tr>
    <tr>
      ...
      <td height="22" class="list_cell_bg"><input name="zd_img6" type="text" id="zd_img6" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_img6','upload',480,150)"></td>
    </tr>
    <tr >
      <td height="30px" class="list_left_title" align="left" colspan="2"><div align="left">
          ...
          <input name="zd_mem_no" type="hidden" id="zd_mem_no" value="<%if(adminInfo != null&&adminInfo.get("usern")!=null)out.print(adminInfo.get("usern"));%>">
