...
<%
//=====页面属性====
String pagename="video_opt.jsp";
String mypy="video_info";
String titlename="视频展场";

//====得到参数====
String myvalue=Common.getFormatInt(request.getParameter("myvalue"));

String urlpath="../used/video_opt.jsp";
if(!myvalue.equals("0"))
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="list_border_bg">
  <form action="opt_save_update.jsp" method="post" name="theform" id="theform" >
    ...
    <tr>
      <td align="right" nowrap class="list_left_title">公司：</td>
      <td class="list_cell_bg"><input name="zd_corporation" type="text" id="zd_corporation" size="50" maxlength="50"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" align="right" nowrap class="list_left_title">视　　频：</td>
      <td height="22" class="list_cell_bg"><input name="zd_video" type="text" id="zd_video" size="50" maxlength="40">
          <input name="selectimg" type="button" class="form_button" id="selectimg" value="上 传" onClick="openWin('http://resource.21-sun.com/web_upload_files.jsp?nurl=<%=request.getServerName()+":"+request.getServerPort()%>&websiteId=19&dir=sell_buy_market&fieldname=zd_video','upload',480,150)"></td>
    </tr>
    <tr>
