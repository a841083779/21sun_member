...
<style type="text/css"> 
body.newyearbg .w980px { width:980px; margin:0 auto; background-color:#fff;}
body.newyearbg { background:#cf0f34 url(http://www.21-sun.com/homepic/13zhounian/year13_bodybg_member.jpg) center top no-repeat; background-attachment:fixed;}
.xslink { display:none; position:fixed; width:1000px; height:0px; left:50%; top:0px; margin-left:-500px; z-index:0;}
* html .xslink { position: absolute; margin-top: expression(0 - parseInt(this.offsetHeight / 2) + (TBWindowMargin = document.documentElement && document.documentElement.scrollTop || document.body.scrollTop) + 'px');
}
.xslink_left { display:block; width:452px; height:625px; position:absolute; z-index:1; left:-452px; top:0px;}
.xslink_right { display:block; width:452px; height:625px; position:absolute; z-index:1; right:-452px; top:0px;}
#ADimg { display:none; width:980px; height:116px; margin:0 auto; clear:both; position:relative;}
#ADimg img.close { width:40px; height:14px; position:absolute; right:0px; bottom:0px; cursor:pointer;}
body.newyearbg .xslink,body.newyearbg #ADimg { display:block;}
body,html { _overflow-x:hidden;}
</style>
</head>
<body onload="setFocus();" id="body" class="newyearbg">
<div class="xslink">                           
<a href="http://ad.21-sun.com/link_to.jsp?paras=0,0,100043&url=http://news.21-sun.com/special/13zhounian/index.jsp" target="_blank" class="xslink_left"></a>
<a href="http://ad.21-sun.com/link_to.jsp?paras=0,0,100043&url=http://news.21-sun.com/special/13zhounian/index.jsp" target="_blank" class="xslink_right"></a>
</div>
<div id="ADimg">
  <a href="http://ad.21-sun.com/link_to.jsp?paras=0,0,100043&url=http://news.21-sun.com/special/13zhounian/index.jsp" target="_blank"><img src="http://www.21-sun.com/homepic/13zhounian/year13_member.jpg" width="980" height="116" /></a>
<img width="40" height="14" title="关闭" class="close" src="http://product.21-sun.com/images/close1.gif" onclick="document.getElementById('body').className=''" />  
</div>
<div class="w980px whitebg">
...
<div class="registForm">
  <div class="registBg">
    ...
    <div style="position: absolute; top: 61px; left: 21px;"><a title="中国工程机械二手网全新改版上线" target="_blank" href="http://ad.21-sun.com/link_to.jsp?paras=1,0,100031&url=http://used.21-sun.com/"><img width="182" height="477" alt="中国工程机械二手网全新改版上线" src="http://www.21-sun.com/homepic/used/used_member.jpg"></a></div>
  </div>
  <div class="clear"></div>
</div>
