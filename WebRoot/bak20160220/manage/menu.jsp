...
query.append("select B.catalog_no,B.catalog_name,B.parent_id,B.back_link from manager_role_purview_new A left outer join cmbol_columns_info B on A.purview_num=B.catalog_no where A.role_num='"+admin_mem_flag+"' ");
//======
...
<body bgcolor="#F0F0F0" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
   ...
   data["-1_70"] = "text:商贸网后台管理系统";
	...
	data['<%=parent_id%>_<%=catalog_no%>'] = 'text:<%=catalog_name%>;url:<%=back_link.equals("")?"javascript:void(0)":back_link%>;target:<%=target%>'; 
     <%}%>	
    //data["70_7201"] = "text:2012感恩钜惠抽奖"; 
    //data["7201_720101"] = "text:留言管理;url:/webadmin/grateful/grateful_guestbook.jsp;target:right"; 
    //data["7201_720102"] = "text:中奖管理;url:/webadmin/grateful/grateful_user.jsp;target:right";
	var xmlstr='';
