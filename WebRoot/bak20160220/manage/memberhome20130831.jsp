...
<div class="memberMain contain950"> 
  ...
  <div class="member_right">
    ...
    <ul class="memberHomeBtns">
      ...
      <li><a href="/manage/membermain.jsp?addflag=8">发布配件</a></li>
    ...
    <div style="width:100px; float:left; padding-top:10px;">
      <a href="http://ad.21-sun.com/link_to.jsp?paras=1,0,100020&url=http://www.wajueji.com/" target="_blank" title="铁臂兄弟连强势回归，火热上线"><img src="http://www.21-sun.com/homepic/tb/tb_member.gif" width="750" height="120" alt="铁臂兄弟连强势回归，火热上线" /></a>
    </div>
  </div>
  <!--right end-->
  <div class="clear"></div>
