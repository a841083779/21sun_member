...
String cacheName = "membermain_market"+sessionMemNo;
%>
...
<%
  ...
  String mess2Market="0";//询价信息  供求
	    
  String [][]mess = DataManager.fetchFieldValue(pool,"member_message","count(id)"," recipients_mem_no='"+Common.getFormatStr(memberInfo.get("mem_no"))+"' and site_flag ='5' and sort_flag=2 "); //留言信息 租赁、二手、配件、供求、配套
	if(mess!=null){mess2Market =Common.getFormatInt(mess[0][0]);}
   ...
   if(site_flag.equals("19")){ //供求
	   marketInfoBuy = DataManager.fetchFieldValue(pool5,"sell_buy_market","count(id)"," mem_no ='"+Common.getFormatStr(memberInfo.get("mem_no"))+"' and is_show=1 ");
...
<div class="loginlist_right" style="height:auto;overflow:hidden">  
  ...
  <div class="loginok_center1" style="width:522px;border:1px #e4eef8 solid">
   ...
   <a style="color:#989796"> 到期时间：</a><a style="font-size:14px;color:#000"><%=tempMemberInfo!=null&&tempMemberInfo[0][7]!=null&&!tempMemberInfo[0][7].equals("")?Common.getFormatStr(tempMemberInfo[0][7]):"-"%></a><br />
    ...
    <div style="width:62px;float:left;"><img src="dlhbaobao.jpg" width="62" height="72"/></div>
  </div>
