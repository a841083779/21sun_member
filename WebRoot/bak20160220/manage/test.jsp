...
%>	 
  ...
  <div class="title" style="cursor:pointer" >我的铁臂空间</div>
		...
		<a href="http://bbs.21-sun.com" target="_blank">铁臂论坛</a><%if(Common.getFormatStr(memberInfo.get("flag_bbs")).equals("1")){%>(已开通)<%}else{%>(<a href="http://bbs.21-sun.com/sso/sso_reg.jsp?key=<%=keyPar%>" target="_blank" class="hong" onclick="if(!confirm('您确认要开通铁臂论坛吗？')){return false;} "><font color="#FF0000">未开通</font></a>)<%}%></li>
  ...
  <div class="loginlist_right">
    <iframe id="iframeRight" name="main" onload="Javascript:SetCwinHeight()" scrolling="no" frameborder="0" width="100%" height="300" src="memberhome.jsp" ></iframe>
  </div>
</div>
