...
<script type="text/javascript">
$.jBox.messager('尊敬的各位小伙伴：<br/><br/>为给广大客户提供一个专业的信息平台，此平台内不允许发布国家禁止的一些敏感词汇，如：色情、刀具、枪支、毒品、赌博等，同时不允许发布与工程机械行业不相关的信息，在您发布过程中，如提示有敏感词汇，请仔细检查信息内容，将敏感词汇删除后即可发布，如仍有问题，请您致电客服热线：<span style="color:red"><b>0535-6792736</b></span>。<br /><br />在此过程中，如给您造成不便，敬请谅解，我们将一如既往给您提供最优质的服务，感谢您对商贸网的关注与支持。<br /><br />', '重要通知',0);
</script>
<%} %>
<!-- 供求通知 -->
<%
