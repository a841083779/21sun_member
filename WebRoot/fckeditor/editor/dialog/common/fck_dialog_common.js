...
function openSelectPicWin(flag,picSort,fieldName) { 
   var w=730;
   var h=570;
   var u="http://192.168.0.221:8880/jrcms/system/workplace/uploads/selectUploadfilesJRcms.action?fieldName="+fieldName+"&jrcmsUploadfiles.flag="+flag+"&jrcmsUploadfiles.picSort="+picSort;
   var n="imgSelect";
