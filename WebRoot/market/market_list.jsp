...
<% if(!state2.equals("1")){ %>“批量更新”操作将使您的信息靠前显示，请及时更新。<%} %>
  ...
  <div class="TabTitleA">
    <ul id="myTab2">
      <li class="activeA" ><% if(mem_flag.equals("1003")){ %>近期信息<%}else{ %>近期信息<%} %></li>
    ...
    <table width="100%" border="0" class="list">
      <tr>
        <td align="left">
			...
			<input type="button" value="跳转到第" name="gotoPage" id="gotoPage" style="width:70px;height:25px;">
			<input type="text" name="gotoOffset" id="gotoOffset" style="width:50px">页
...
<script type="text/javascript">
	...
	var gotoOffset=$("#gotoOffset").val();
	window.location.href="?offset="+((gotoOffset-1)*18)+"&";
	});
