...
<div class="loginlist_right">
  ...
  <div class="member_rightTitle">
	...
	<%=((String)memberInfo.get("mem_name"))%>，您好，您的专属客服 王啸 客服电话：0535-6792761，
    ...
    <form action="<% if(isPub){  %>opt_save_update_freemaker_randsb.jsp<%}else{ %><%} %>" method="post" name="theform" id="theform" submited="true">
      <table width="95%" border="0" align="center" cellpadding="0"
        ...
        <tr>
          <td nowrap="nowrap">&nbsp;</td>
          <td>
           <% if(isPub&&"2".equals(userInfoFlag)){  %>
		...
		<!--是否正常入口发布-->
		 <input type="hidden" name="<%=prxStr+"_"%>checks" id="<%=prxStr+"_"%>checks" value="会员供求入口" />
      </table>
    </form>
  </div>
</div>
...
<script type="text/javascript">
  ...
  function showLimit(){
		$.jBox.info('免费会员每天只能发布5条新信息，感谢您对中国工程机械商贸网的支持。<br />如有疑问请咨询：0535-6792761。', '提示');
	}
</script>