...
<div class="registForm">
  <div class="registBg">
    ...
    <div class="registTable">
      <form id="theform" name="theform" method="post" action="member_reg_action_rand23.jsp"  onsubmit="return regYanzheng();" >
    ...
    <div style="position: absolute; top: 61px; left: 21px;"><a title="工程机械图片库" target="_blank" href="http://product.21-sun.com/activity/tuku/"><img width="182" height="477" alt="分享真实用机感受" src="http://ad.21-sun.com/homepic/tiebi/zhuce.jpg"></a></div>
  </div>
  <div class="clear"></div>
</div>
