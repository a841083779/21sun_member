...
<%@page import="org.apache.commons.httpclient.methods.GetMethod"%> 
  ...
  <div class="hometop">
<div class="homelogo"><h1><a href="http://www.21-sun.com" target="_blank" style="display:block; width:128px; height:65px;"><img src="http://ad.21-sun.com/homenewads/21logo1.gif" width="128" height="65" alt="中国工程机械商贸网" /></a></h1></div>
<div class="top1_2g" style="width:67px;"><img src="http://member.21-sun.com/images/my21.gif" /></div>
<!--导航开始--> 
<%
