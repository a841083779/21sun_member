...
<div class="memberMain contain950"> 
  ...
  <div class="member_left">
    ...
    <div class="Newmenu">
      <ul>
        ...
        <li><a href="/home/part/product/category.jsp">发布配件信息</a></li>
  ...
  <div class="member_right">
    <div class="welcome01"> <strong>您好！<%=Common.getFormatStr(memberInfo.get("mem_name"))%></strong>
	
	<%
	if(tempMemberInfo[0][6]!=null&&!tempMemberInfo[0][6].equals("")){%>
	<%if(Common.getFormatStr(tempMemberInfo[0][6]).equals("A类会员")){%>
	&nbsp;&nbsp; &nbsp;您的专属客服是  王啸  客服电话：0535-6792761  
	<a href="http://wpa.qq.com/msgrd?V=1&Uin=2173738198&Site=中国工程机械商贸网&Menu=yes" target="_blank" title="在线咨询">QQ：2173738198</a>
	 欢迎您的来电咨询
	<%}}%>
    ...
    <ul class="memberHomeBtns">
      ...
      <li><a href="/home/part/product/category.jsp">发布配件</a></li>
    ...
    <div style="width:100px; float:left; padding-top:10px;">
      <a href="http://www.wajueji.com/" target="_blank" title="爱在铁臂，难以离开！"><img src="/images/ad_huiyuan_01.jpg" width="750" height="120" alt="爱在铁臂，难以离开！" /></a>
    </div>
  </div>
  <!--right end-->
  <div class="clear"></div>
