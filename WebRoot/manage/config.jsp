...
String sql="select * from pro_products where is_show=1 order by id desc";
List<Map> list =dbHelper.getMapList(sql);
for(Map map:list){
    String pro_name=Common.getFormatStr(map.get("pro_name"));
	String catalog_name=Common.getFormatStr(map.get("catalog_name"));
    String title=Common.getFormatStr(map.get("title"));
	String 
}
%>