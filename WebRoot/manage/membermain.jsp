...
<div class="memberMain contain950"> 
  ...
  <div class="member_left">
    <div class="memberPart">
      ...
      <ul>
        <%
						...
						%>
        <a href="membermain.jsp?addflag=<%=tempSubPurviewAddFlag%>"><%=tempSubPurviewName%><strong></strong> </a>
        <%
							} else {
						%>
    ...
    <%}else{%>
    	<div class="Newmenu noMargin">
      <ul>
        <li> <a href="#" onclick="wanshan();"><strong style="color:red">开通店铺</strong></a> </li>
      </ul>
    </div>
    <%}%>
    <div class="Newmenu noMargin">
    ...
    <div class="hotLine">
      <h3> 咨询热线 </h3>
      <div class="hottel"> <font color="white">0535-6792761</font> <br />
...
jQuery(document).ready(function(){
 ...
 &#12288;&#12288; 图片质量的好坏直接影响到您的产品对买家的吸引力，好的图片拥有更多的曝光几率。图片最好满足280*210的像素。
		 ...
		 <li class="hp_t" onclick="getMessage();">
          <b>发布建议</b>
          <span class="ico"></span>
        </li>
      </ul>
...
<script>
function getMessage (){
$.jBox.messager('尊敬的各位小伙伴：<br/><br/>　　发布高质量的信息，可以让买家搜索产品时，更容易找到信息，同事可以提高买家选择合作和交易的意愿，更能提高您产品在搜索引擎中的排名。下面具体介绍一下信息发布的规范：<br/>一、标题怎么写容易被收录？<br/>标题是信息内容的核心浓缩，表述清晰并且包含产品关键信息的标题，能让用户更容易了解产品，吸引兴趣，标题是用户能够搜索到您产品的重要根据，所以在填写标题的时候需要注意以下几点：<br/>1、  字数不应太多，要准确和完整，一条信息对应一个产品，只能描述一个产品（如：“小松 PC200-7 ,300-7电脑板插头”http://market.21-sun.com/viewSellBuy_for_5696223.htm，建议分拆成“小松PC200-7挖掘机电脑板插头”和“小松PC300-7挖掘机电脑板插头” ）。<br/>2、  标题中需要增加与产品相关的描述词，突出卖点。<br/>3、  文章标题要结合客户的内容和客户的搜索习惯进行编写，更有利于排名和收录。<br/>4、  标题要与所发内容一致，避免出现标题与内容产品不同。<br/>二、准确的类目选择更容易被收录。<br/>在发布产品是，必须根据您所发布的产品选择正确的类目，这个类目将决定您的产品分类，正确的类目选择可以跟您的产品对应，更有利于收录。如果找不到您所需要的类目，请点击其他来发布您的产品。<br/>三、产品描述怎么填写能促进收录？<br/>产品描述是访问者了解产品的重要信息，也是大多数访问者都会仔细查看的内容，是可以彰显产品的专业品质和企业实力的区域，能够让访问者对您更放心，所以在编写产品描述的时候要注意以下几点：<br/>1、  产品描述要详细，完整，可读性高，字数尽量不少于300字，不多于2000字。<br/>2、  不要罗列产品型号，也不要重复发某个词或某个短语。<br/>3、  内容要跟标题相应，与标题对应的文章更容易被百度收录。<br/>4、  最好产品描述中不要加入网站链接，可以增强收录。<br/>5、  发布产品的排版要规范，分段阐述更能受到客户喜爱，对收录也有很大帮助。<br/>四、插入图片更容易促进收录，吸引客户<br/>图片质量直接影响您产品对买家的吸引力，高清的图片可以被收录，但是要注意请不要盗用他人图片。产品图片会在搜索页面结果中出现，一个好的图片也可以带来好的收录与排名。发布图片的注意事项：<br/>1、  图片格式为JPG,GIF,PNG等；<br/>2、  图片要求不带水印；<br/>3、  图片要求清晰，可见度高；<br/>4、  图片要跟产品对应，更有利于收录。', '供求市场信息发布建议',0 ,{ width: 600});
}
</script>
<!-- 配件通知 -->  
<%
...
<script type="text/javascript">
$.jBox.messager('尊敬的各位小伙伴：<br/><br/>为给广大客户提供一个专业的信息平台，此平台内不允许发布国家禁止的一些敏感词汇，如：色情、刀具、枪支、毒品、赌博等，同时不允许发布与工程机械行业不相关的信息，在您发布过程中，如提示有敏感词汇，请仔细检查信息内容，将敏感词汇删除后即可发布，如仍有问题，请您致电客服热线：<span style="color:red"><b>0535-6792761</b></span>。<br /><br />在此过程中，如给您造成不便，敬请谅解，我们将一如既往给您提供最优质的服务，感谢您对商贸网的关注与支持。<br /><br />', '重要通知',0);
</script>
<%} %>
<!-- 供求通知 -->
<%
