...
<%
	...
	try {
		...
		if("checkInputInfo".equals(flag)){
			...
			keyWordsList = DataManager.fetchFieldValue(pool,"comm_filter_keywords","keyword","is_show=1") ;
			for(int i=0;i<keyWordsList.length;i++){
				if(info.indexOf(keyWordsList[i][0].replace("\\s*",""))>0){// 含有第感词
					 out.println("so") ;
					//return false ;
				   break ; 
				}
