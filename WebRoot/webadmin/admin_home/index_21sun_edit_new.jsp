...
<form id="theform" name="theform" method="post" action="opt_save_update.jsp">
  ...
  <td colspan=2 align=center >所属栏目：<%=type%></td>
    ...
    <tr>
      ...
      <td  ><input name="zd_sub_title"  type="text" Class="xmlInput textInput5" id="zd_sub_title" value="" size="10"  >&nbsp;&nbsp;<input type="button" value="选中文字点击变红" onClick="repl_red('zd_sub_title');"></td>
    </tr>
    <tr>
 ...
 <td width="15%" align="center"  >主标题：</td>
      <td colspan="3"  ><input name="zd_title"  type="text" Class="xmlInput textInput5" id="zd_title" value="" size="50" dataType="Require" msg="新闻标题不能为空">&nbsp;&nbsp;<input type="button" value="选中文字点击变红" onClick="repl_red('zd_title');">
       </td>
    </tr>
    <tr>
      <td width="15%" align="center"  >主标题链    接：</td>
    ...
    <tr>
      ...
      <td  ><input name="zd_order_no"  type="text"  Class="xmlInput textInput5" id="zd_order_no" value="" size="5" >
    </tr>
