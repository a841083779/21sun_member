...
if(pool==null){
	...
	try {
		...
		String query = "select * from index_21sun "+searchStr+" and sort_flag =5 order by sort_flag,order_no";
      ...
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
			...
			<td height="15" width="12%">
            <input type="button" name="b_add" value="增加多条页" onclick="openWin('<%=pageSubName%>','win',700,600)"/>
            </td>
			<td height="15" width="10px">
           <a href="http://www.21-sun.com/tools/createNewProducts.jsp" target="_blank">最新产品</a>
            </td>
		
			<td height="15" width="10px" align="left">
