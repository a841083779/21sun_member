...
if(pool==null){
	pool = new PoolManager();
	 ...
	 String tablename="aboutus_news";
	 String pageSubName = "info_edit.jsp";
	...
	try {
		...
		if(!"".equals(year)){
			searchStr+=" and pub_date like '%"+year+"%'";
		}
		String query = "select * from aboutus_news "+searchStr+" order by pub_date desc";
    ...
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            年份：<input name="year" id="year" type="text" value="<%=year %>" class="xmlInput" style="width:150px">(2011)     
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td   align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>标题</strong></span></div></td>
            <td   align="center" bgcolor="e8f2ff"><div align="center"><span class="p92z"><strong>链接</strong></span></div></td>
           ...
           <td  style='text-align: left; ' nowrap="nowrap" align="center">
                                             ...
                                             <a href="#" onclick="openWin('<%=pageSubName%>?id=<%=rs.getString("id")%>','win',800,600)">
                                               ...
                                               <td style='text-align: center; ' nowrap="nowrap">
                                              			<%=Common.getFormatStr(rs.getString("url")) %>
                                              </td>
                                              <td style='text-align: center; ' nowrap="nowrap">
