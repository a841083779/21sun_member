...
if(pool==null){
	...
	try {
		...
		String query = "select * from index_21sun "+searchStr+" and sort_flag in(1,2) order by sort_flag,order_no";		System.out.print("...." + query);
  ...
  <table width="95%"  border="0"  cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <option value="1" <%if(sort_flag.equals("1"))out.print("selected");%>>最新资讯</option>
