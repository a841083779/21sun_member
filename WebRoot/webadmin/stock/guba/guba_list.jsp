...
//=====页面属性====
String tablename="stock_guba";
String pageSubName="guba_opt.jsp";
...
if(!find_author.equals("")){
	query.append(" and add_ip like '%"+find_author+"%'");
}
/*标题*/ 
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><%=Common.getFormatStr(rs.getString("add_ip"))%></td>
