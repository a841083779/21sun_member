...
String pageSubName="perspective_opt.jsp?";
...
StringBuffer query =new StringBuffer("select id,title,source,pub_date from "+tablename+" where sort_num='40'");

/*标题*/ 
String find_source=Common.getFormatStr(request.getParameter("find_source"));
if(!find_source.equals("")){
	query.append(" and source like '%"+find_source+"%'");
}
/*标题*/ 
    ...
    <tr>
      <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            来源：<input name="find_source" type="text" id="find_source" value="<%=find_source%>" size="10" />
        ...
        <table width="98%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="20%" align="center" bgcolor="e8f2ff"><strong>来源</strong></td>
...
%>
          <tr  <%=(k%2)==1?"bgcolor='#F9F9F9'":""%>>
            ...
            <td align="center"><%=Common.getFormatStr(rs.getString("source"))%></td>
