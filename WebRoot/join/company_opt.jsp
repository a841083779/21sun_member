...
String urlpath = "company_opt.jsp";
String cla="";
...
if("".equals(mem_no)){
	userMap = adminInfo;
	corporation =  Common.getFormatStr(userMap.get("comp_name"));
	address =  Common.getFormatStr(userMap.get("comp_address"));
	postalcode =  Common.getFormatStr(userMap.get("comp_postcode"));
	fullname =  Common.getFormatStr(userMap.get("mem_name"));
	telephone =  Common.getFormatStr(userMap.get("per_phone"));
	fax =  Common.getFormatStr(userMap.get("comp_fax"));
	email =  Common.getFormatStr(userMap.get("per_email"));
	homepage =  Common.getFormatStr(userMap.get("comp_url"));
	introduction =  Common.getFormatStr(userMap.get("comp_intro"));
	mem_flag= Common.getFormatStr(userMap.get("mem_flag"));
}
...
function sub(){
	...
	var str_zd_corporation = document.getElementById("zd_corporation").value;
	if(str_zd_corporation==''){
		alert("请输入公司名称");
		document.getElementById("zd_corporation").focus();
		return false;
	}

	var str_zd_address = document.getElementById("zd_address").value;
	if(str_zd_address==''){
		alert("请输入联系地址");
	...
	var str_zd_province = document.getElementById("zd_province").value;
	if(str_zd_province==''){
		alert("请选择地域");
 ...
 var str_zd_postalcode = document.getElementById("zd_postalcode").value;
	if(str_zd_postalcode==''){
		alert("请输入邮编");
		document.getElementById("zd_postalcode").focus();
		return false;
	}
		
	var str_zd_fullname = document.getElementById("zd_fullname").value;
	if(str_zd_fullname==''){
		alert("请输入联系人名称");
	...
	var str_zd_telephone = document.getElementById("zd_telephone").value;
	if(str_zd_telephone==''){
		alert("请输入联系电话");
	...
	var str_zd_introduction = document.getElementById("zd_introduction").value;
	if(str_zd_introduction==''){
		alert("请输入联系公司简介");
	...
	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="100%">
					<form method="POST" action="opt_save.jsp" name="theform"  >
						...
						<input type="hidden" name="zd_id" value="0"  >
						 ...
						 <input type="hidden" name="zd_class" id="zd_class" value=""  >
						 <input type="hidden" name="zd_order_by" value="9999"  >
						 <input type="hidden" name="zd_ispublished" value="1"  >
						...
						<div align="center" class="loginlist_right1">
							...
							<table border="0" cellpadding="2" cellspacing="0" width="100%"  >
								...
								<tr>
									...
									<td width="90%" align="left">
									<select name="zd_province" size="1" id="zd_province">
          		...
          		<%=Common.option_str(pool,"lstdistrict","id1,district","id1%10!=0","",0) %>          		</cache:cache>
								...
								<tr>
									...
									<td width="90%" align="left"><input type="text" name="zd_corporation" id="zd_corporation" value="<%=corporation %>" size="50" maxlength="20" >
									 </td>         
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><font color="#FF0000">*</font> <span class="grayb">联系地址：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_address" id="zd_address" size="50"  value="<%=address %>"   maxlength="30">
									 </td>         
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><font color="#FF0000">*</font> <span class="grayb">邮政编码：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_postalcode" id="zd_postalcode" size="10"   value="<%=postalcode %>"  maxlength="20">
									 </td>         
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><font  color="#FF0000">*</font> <span class="grayb">联 系 人：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_fullname" id="zd_fullname" size="20"  value="<%=fullname %>"   maxlength="20">
									 </td>         
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><font color="#FF0000">*</font> <span class="grayb">联系电话：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_telephone" id="zd_telephone" size="30"   value="<%=telephone %>"  maxlength="20">
									 </td>         
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><span class="grayb">传&nbsp;&nbsp;&nbsp;          
									真：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_fax" id="zd_fax" size="20"  value="<%=fax %>"   maxlength="20"> </td>
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><span class="grayb">电子邮件：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_email" id="zd_email" size="50"   value="<%=email %>" > </td>
								</tr>
								<tr>
									<td width="10%" align="right" nowrap><span class="grayb">公司主页：</span></td>
									<td width="90%" align="left"><input type="text" name="zd_homepage" id="zd_homepage" size="50"  value="<%=homepage %>"   maxlength="40"> </td>
								</tr>
								<tr>
									<td width="10%" align="right" nowrap valign="top"><span class="grayb">主营业务：<br>
									</span> 
									</td>
									<td width="90%" align="left"><textarea rows="5" name="zd_bussiness" id="zd_bussiness" cols="60" style="overflow-y:scroll;"></textarea></td>
								</tr>
								 
								<tr>
									<td width="10%" align="right" nowrap valign="top"><font color="#FF0000">*</font><span class="grayb">公司简介：</span></td>
									<td width="90%" align="left"><textarea rows="5" name="zd_introduction" id="zd_introduction" cols="60" style="overflow-y:scroll;"><%=Common.filterHtmlString(introduction.replace("<br />","\r\n"))%></textarea></td>
								</tr>
								<tr>
		<td  height="22" align="right" nowrap class="list_left_title"><font color="#FF0000">*</font><span class="grayb">验 证 码：</span></td>
		<td height="22" class="list_cell_bg">		  
		<input type="text" id="rand" name="rand" value="" size="20" maxlength="10"  class="moren"/>
		<img src="/webadmin/authImgServlet" name="authImg" align="absmiddle" id="authImg" title="如果您看不清，请在图片上单击，可以更换验证码！" onClick="refresh();"/>		 
		 </td>
	</tr>
	<tr>
		...
		<td class="right"><input type="button" id="submitId" name="Submit" value="发 布" class="tijiao" style="cursor:pointer"  onClick="sub()"/></td>
	</tr>
							</table>
							</center>
						</div>
