...
<%
	...
	StringBuffer query =new StringBuffer("select id,no,product_name,update_date,view_count,collection_count,is_show from "+tablename+" where mem_no = '"+(String)adminInfo.get("mem_no")+"' order by update_date desc");
	try{
...
<div class="loginlist_right">
  <div class="loginlist_right2"><span class="mainyh">管理我的产品信息</span></div>
  <div class="loginlist_right2"><b>友情提示</b>：该栏目是发布<b style="color:#0000FF">配套件产品</b>信息的入口，<a href="/manage/membermain.jsp?addflag=20" target="_parent"><span style="color:#0000FF">供求信息</span></a>请到<a href="/manage/membermain.jsp?addflag=20" target="_parent"><span style="color:#0000FF">供应</span></a>、<a href="/manage/membermain.jsp?addflag=21" target="_parent"><span style="color:#0000FF">求购</span></a>栏目处发布，该栏目除产品信息外，其它信息将被管理员删除;<strong>"更新"</strong>操作将会使您的信息靠前显示;<strong>"暂停发布"</strong>功能将会使该条信息在前台暂不显示</div>
  <div class="loginlist_right1"><span class="title_bar">
    <input name="add_b" type="button" class="form_button" id="add_b" value="" style="width:78px;height:25px;border:none;background:url(../images/bottom03.gif) left top no-repeat;cursor: pointer;" onclick="window.location.href='product_opt.jsp'" />
    ...
    <table width="100%" border="0" class="list">
      <tr>
        ...
        <th width="33%">品名(点击预览)</th>
        <th width="9%"><div align="center">浏览量</div></th>
        <th width="9%"><div align="center">收藏量</div></th>
      ...
      <tr>
        ...
        <td><a href="<%=fittingsUrl+"/product/detail_for_"+Common.getFormatStr(rs.getString("id"))+".htm"%>" class="blue14" target="_blank" title="<%=Common.getFormatStr(rs.getString("product_name"))%>"><%=Common.substringByte(rs.getString("product_name"),30)%></a></td>
