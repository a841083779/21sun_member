...
<%
	...
	StringBuffer query =new StringBuffer("select add_date,mem_name,province,city,telephone,email,company from fittings_collection_view_info where flag = '"+flag+"' and parent_no = '"+no+"' order by add_date desc");
	String proStatSql = "select top 15 province,count(*) as count from fittings_collection_view_info where flag = '"+flag+"' and parent_no = '"+no+"' group by province order by count desc";
	try{
...
<div>
  ...
  <div>
    ...
    <script type="text/javascript">
	var xmlData="<chart logoURL='images/new01-1.gif' logoPosition='CC' logoAlpha='10' logoScale='150'  caption='收藏量地区访问统计' exportEnabled='0' exportAtClient='1' exportHandler='fcExporter1' exportDialogMessage='正在导出，请稍候...' exportFileName='图表' exportFormats='JPG=导出JPG文件|PNG=导出PNG文件|PDF=导出PDF文件'  >";
<%
 while(rsStat.next()){
%>
  ...
  <div class="loginlist_right1">
    <table width="100%" border="0" class="list">
      <tr>
        ...
        <th width="12%"><div align="center">收藏日期</div></th>
      </tr>
      <%
