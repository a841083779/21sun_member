...
String comp_id = Common.getFormatStr(memberInfoMap.get("id")) ;
%>
<%
	//=====页面属性====
...
<form action="opt_save_update.jsp" method="post" name="theform" id="theform">
  <div class="loginlist_right">
    <div class="loginlist_right2"> <span class="mainyh" style="float:left">发布租赁设备信息</span>
      <%if(mem_flag.equals("1005")){ %>
      <div style="width:120px; float:right;line-height:35px; font-weight:bold;"><a href="http://www.21-rent.com/shop/shopdetail<%=rent_mode %>_for_<%=comp_id %>.htm" target="_blank">进入我的店铺&gt;&gt;</a>
        <%} %>
      </div>
    </div>
    <div class="loginlist_right1" style="clear:both;">
      <table>
        <tr>
          ...
          <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" class="biaoge">
              ...
              <tr>
                ...
                <td height="22" class="list_cell_bg">
				  <input type="radio" id="radio" name="zd_rent_state" value="1" checked="checked" onClick="dochange(1);">待租
                  <input type="radio" id="radio" name="zd_rent_state" value="2" onClick="dochange(2);">施工中 
				</td>
              </tr>
              ...
              <tr>
                ...
                <td width="26%" class="list_cell_bg"><input type="radio" name="zd_place" checked="checked" id="zd_place" value="0"> 国产 &nbsp;&nbsp;
                  <input type="radio" name="zd_place"  id="zd_place" value="1">  进口 &nbsp;&nbsp;
				  </td>
               <td height="22" nowrap class="list_left_title"><strong>工作时间：</strong></td>
                <td height="22" class="list_cell_bg">
				<input name="zd_workingtime" type="text" id="zd_workingtime" size="5" maxlength="30" 	onKeyUp="isNumeric(this,'zd_workingtime');">  (小时)
				</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="22" class="list_cell_bg" width="500">
				<input type="radio" id="zd_is_operater" name="zd_is_operater" value="1" > 是
                  <input type="radio" id="zd_is_operater" name="zd_is_operater" value="0" checked="checked"> 否 
				  </td>
              </tr>
              <tr>
              ...
              <tr id="showimg1" style="display:''">
                ...
                <td height="22" class="list_cell_bg" colspan="3"><input name="zd_img1" id="zd_img1" type="hidden" value="" />
                  ...
                  <iframe id="ifr2_zd_img1" scrolling="no" frameborder="0" width="100%" height="28" src="http://resource.21-sun.com/web_upload_files_for_smallpic.jsp?nurl=<%=request.getServerName() + ":"+ request.getServerPort()%>&websiteId=22&dir=rent&fieldname=zd_img1&smallpic=zd_img1_1"></iframe>
              ...
              <tr>
                ...
                <td height="22" class="list_cell_bg" colspan="3">
				<input type="text" id="rand" name="rand" value="" size="20" maxlength="10" class="moren" />
                  <img src="" name="authImg" align="absmiddle" id="authImg" 	title="如果您看不清，请在图片上单击，可以更换验证码！" onClick="refresh();" />
                  <input name="zd_title" type="hidden" id="zd_title" size="50" 	maxlength="50">
				  </td>
              </tr>
              <tr>
            ...
            <input name="zd_orderno1" type="hidden" id="zd_orderno1" /></td>
        </tr>
        <tr>
