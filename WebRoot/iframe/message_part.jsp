...
<%}%>
 <form action="opt_save_update.jsp" method="post" name="theform" id="theform" onSubmit="return Validator.Validate(this,2)">
  ...
  <input name="zd_recipients_mem_no" type="hidden" id="zd_recipients_mem_no" value="<%=recipients_mem_no%>"></td>
    ...
    <td width="76%" height="130" bgcolor="#F8F8F8" align="left">
    	<%
   			String defaultContent="";
   			if(sort_flag.equals("1")){
   				defaultContent=zd_content.equals("") ? "您好，我可以供应您需要的配件，请与我联系，谢谢！" : zd_content;
   			}else if (sort_flag.equals("2")){
   				defaultContent=zd_content.equals("") ? "您好，我对"+(titlename.equals("") ? "此" : titlename)+"感兴趣，想要咨询，请与我联系，谢谢！" : zd_content;
   			}
   		%>
    	<textarea name="zd_content" cols="40" rows="6" class="p92" id="zd_content" maxlength=500 dataType="Require" msg="留言内容不能为空" onKeyUp="if((this.value).length&gt;300){ this.value=(this.value).substr(0,300);alert('留言内容已超出最大字数！');}"><%=defaultContent.trim() %></textarea>
    </td>
     </tr>
    <tr>
    ...
    <td width="76%" height="25" bgcolor="#F8F8F8" align="left">
    	<input name="zd_telephone" type="text"  id="zd_telephone" value="<%=zd_telephone%>" size="30" maxlength=20 dataType="Require" msg="联系电话不能为空">
    </td>
    </tr>
	 <tr>
